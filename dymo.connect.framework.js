...
goog.global = this, goog.global.CLOSURE_UNCOMPILED_DEFINES, goog.global.CLOSURE_DEFINES, goog.isDef = function(e) {
    ...
    for (; g.length && (r = g.shift());) !g.length && goog.isDef(o) ? n[r] = o : n = n[r] ? n[r] : n[r] = {}
    ...
    if (goog.DEPENDENCIES_ENABLED) {
        for (var g, n, i = e.replace(/\\/g, "/"), a = goog.dependencies_, s = 0; g = o[s]; s++) a.nameToPath[g] = i, a.pathIsModule[i] = !!r;
        for (var l = 0; n = t[l]; l++) i in a.requires || (a.requires[i] = {}), a.requires[i][n] = !0
    }
    ...
    if (goog.global.CLOSURE_BASE_PATH) goog.basePath = goog.global.CLOSURE_BASE_PATH;
        ...
        for (var e = goog.global.document.getElementsByTagName("SCRIPT"), o = e.length - 1; 0 <= o; --o) {
            var t = e[o].src,
                r = t.lastIndexOf("?"),
                g = -1 == r ? t.length : r;
            if ("base.js" == t.substr(g - 7, 7)) return void(goog.basePath = t.substr(0, g - 7))
        }
    ...
    try {
        ...
        if (goog.moduleLoaderState_.declareLegacyNamespace ? goog.constructNamespace_(r, t) : goog.SEAL_MODULE_EXPORTS && Object.seal && Object.seal(t), goog.loadedModules_[r] = t, goog.moduleLoaderState_.declareTestMethods)
            for (var g in t) 0 !== g.indexOf("test", 0) && "tearDown" != g && "setUp" != g && "setUpPage" != g && "tearDownPage" != g || (goog.global[g] = t[g])
    } finally {
    ...
    if (goog.inHtmlDocument_()) {
        ...
        else t.write('<script type="text/javascript">' + o + "<\/script>");
        return !0
    }
    return !1
}, goog.lastNonModuleScriptIndex_ = 0, goog.onScriptLoad_ = function(e, o) {
    ...
    function n(e) {
        if (!(e in g.written))
            if (e in g.visited) e in r || (r[e] = !0, t.push(e));
            else {
                if (g.visited[e] = !0, e in g.requires)
                    for (var o in g.requires[e])
                        if (!goog.isProvided_(o)) {
                            if (!(o in g.nameToPath)) throw Error("Undefined nameToPath for " + o);
                            n(g.nameToPath[o])
                        } e in r || (r[e] = !0, t.push(e))
            }
    }
    for (var e in goog.included_) g.written[e] || n(e);
    ...
    for (o = 0; o < t.length; o++) {
        if (!(e = t[o])) throw goog.moduleLoaderState_ = i, Error("Undefined script input");
        g.pathIsModule[e] ? (!0, goog.importModule_(goog.basePath + e)) : goog.importScript_(goog.basePath + e)
    }
    ...
    if (!COMPILED) {
        ...
        goog.IS_OLD_IE_ ? (goog.dependencies_.deferred[o] = g, goog.queuedModules_.push(o)) : t(e, g)
    }
    ...
    if (goog.global.execScript) goog.global.execScript(e, "JavaScript");
        ...
        if (null == goog.evalWorksForGlobals_ && (goog.global.eval("var _et_ = 1;"), void 0 !== goog.global._et_ ? (delete goog.global._et_, goog.evalWorksForGlobals_ = !0) : goog.evalWorksForGlobals_ = !1), goog.evalWorksForGlobals_) goog.global.eval(e);
        else {
            var o = goog.global.document,
                t = o.createElement("SCRIPT");
...
}, goog.evalWorksForGlobals_ = null, goog.cssNameMapping_, goog.cssNameMappingStyle_, goog.getCssName = function(e, o) {
    function g(e) {
        return goog.cssNameMapping_[e] || e
    }
    var t;
    return t = goog.cssNameMapping_ ? "BY_WHOLE" == goog.cssNameMappingStyle_ ? g : function(e) {
        for (var o = e.split("-"), t = [], r = 0; r < o.length; r++) t.push(g(o[r]));
        return t.join("-")
    } : function(e) {
        return e
    }, o ? e + "-" + t(o) : t(e)
    ...
    function o() {}
    o.prototype = n.prototype, e.superClass_ = n.prototype, e.prototype = new o, (e.prototype.constructor = e).base = function(e, o, t) {
        for (var r = new Array(arguments.length - 2), g = 2; g < arguments.length; g++) r[g - 2] = arguments[g];
    ...
    if (r.superClass_) {
        for (var g = new Array(arguments.length - 1), n = 1; n < arguments.length; n++) g[n - 1] = arguments[n];
        return r.superClass_.constructor.apply(e, g)
    }
    var i = new Array(arguments.length - 2);
    for (n = 2; n < arguments.length; n++) i[n - 2] = arguments[n];
    for (var a = !1, s = e.constructor; s; s = s.superClass_ && s.superClass_.constructor)
        if (s.prototype[o] === r) a = !0;
        else if (a) return s.prototype[o].apply(e, i);
    ...
    return e && goog.inherits(g, e), delete o.constructor, delete o.statics, goog.defineClass.applyProperties_(g.prototype, o), null != r && (r instanceof Function ? r(g) : goog.defineClass.applyProperties_(g, r)), g
}, goog.defineClass.ClassDescriptor, goog.define("goog.defineClass.SEAL_CLASS_INSTANCES", goog.DEBUG), goog.defineClass.createSealingConstructor_ = function(o, e) {
    if (goog.defineClass.SEAL_CLASS_INSTANCES && Object.seal instanceof Function) {
        if (e && e.prototype && e.prototype[goog.UNSEALABLE_CONSTRUCTOR_PROPERTY_]) return o;
        var t = function() {
            var e = o.apply(this, arguments) || this;
            return e[goog.UID_PROPERTY_] = e[goog.UID_PROPERTY_], this.constructor === t && Object.seal(e), e
        };
        return t
    }
    return o
...
}, goog.UNSEALABLE_CONSTRUCTOR_PROPERTY_ = "goog_defineClass_legacy_unsealable", goog.provide("goog.debug.Error"), goog.debug.Error = function(e) {
    ...
    NOTATION: 12
}, goog.provide("goog.string"), goog.provide("goog.string.Unicode"), goog.define("goog.string.DETECT_DOUBLE_ESCAPING", !1), goog.define("goog.string.FORCE_NON_DOM_HTML_UNESCAPING", !1), goog.string.Unicode = {
    NBSP: "Â "
    ...
    for (var t = e.split("%s"), r = "", g = Array.prototype.slice.call(arguments, 1); g.length && 1 < t.length;) r += t.shift() + g.shift();
    return r + t.join("%s")
...
}, goog.string.numerateCompareRegExp_ = /(\.\d+)|(\d+)|(\D+)/g, goog.string.numerateCompare = function(e, o) {
    if (e == o) return 0;
    if (!e) return -1;
    if (!o) return 1;
    ...
    return o ? (e = e.replace(goog.string.AMP_RE_, "&amp;").replace(goog.string.LT_RE_, "&lt;").replace(goog.string.GT_RE_, "&gt;").replace(goog.string.QUOT_RE_, "&quot;").replace(goog.string.SINGLE_QUOTE_RE_, "&#39;").replace(goog.string.NULL_RE_, "&#0;"), goog.string.DETECT_DOUBLE_ESCAPING && (e = e.replace(goog.string.E_RE_, "&#101;"))) : goog.string.ALL_RE_.test(e) && (-1 != e.indexOf("&") && (e = e.replace(goog.string.AMP_RE_, "&amp;")), -1 != e.indexOf("<") && (e = e.replace(goog.string.LT_RE_, "&lt;")), -1 != e.indexOf(">") && (e = e.replace(goog.string.GT_RE_, "&gt;")), -1 != e.indexOf('"') && (e = e.replace(goog.string.QUOT_RE_, "&quot;")), -1 != e.indexOf("'") && (e = e.replace(goog.string.SINGLE_QUOTE_RE_, "&#39;")), -1 != e.indexOf("\0") && (e = e.replace(goog.string.NULL_RE_, "&#0;")), goog.string.DETECT_DOUBLE_ESCAPING && -1 != e.indexOf("e") && (e = e.replace(goog.string.E_RE_, "&#101;"))), e
    ...
    return g = o ? o.createElement("div") : goog.global.document.createElement("div"), e.replace(goog.string.HTML_ENTITY_PATTERN_, function(e, o) {
        var t = n[e];
        if (t) return t;
        if ("#" == o.charAt(0)) {
        ...
        return t || (g.innerHTML = e + " ", t = g.firstChild.nodeValue.slice(0, -1)), n[e] = t
    })
    ...
    for (var t = o.length, r = 0; r < t; r++) {
        ...
        if (e.charAt(0) == g && e.charAt(e.length - 1) == g) return e.substring(1, e.length - 1)
    }
    return e
    ...
    if (t && (e = goog.string.unescapeEntities(e)), r && e.length > o) {
        ...
        var i = Math.floor(o / 2),
            a = e.length - i;
        i += o % 2, e = e.substring(0, i) + "..." + e.substring(a)
    }
    ...
    var o = e,
        t = e.charCodeAt(0);
    return 31 < t && t < 127 ? o = e : (t < 256 ? (o = "\\x", (t < 16 || 256 < t) && (o += "0")) : (o = "\\u", t < 4096 && (o += "0")), o += t.toString(16).toUpperCase()), goog.string.jsEscapeCache_[e] = o
    ...
    var r = goog.isDef(t) ? e.toFixed(t) : String(e),
        g = r.indexOf(".");
    return -1 == g && (g = r.length), goog.string.repeat("0", Math.max(0, o - g)) + r
    ...
    for (var o = 0, t = 0; t < e.length; ++t) o = 31 * o + e.charCodeAt(t), o %= goog.string.HASHCODE_MAX_;
    return o
    ...
    for (var r = e.split(o), g = []; 0 < t && r.length;) g.push(r.shift()), t--;
    ...
    return r[o.length]
}, goog.provide("goog.asserts"), goog.provide("goog.asserts.AssertionError"), goog.require("goog.debug.Error"), goog.require("goog.dom.NodeType"), goog.require("goog.string"), goog.define("goog.asserts.ENABLE_ASSERTS", goog.DEBUG), goog.asserts.AssertionError = function(e, o) {
...
}, goog.provide("goog.array"), goog.provide("goog.array.ArrayLike"), goog.require("goog.asserts"), goog.define("goog.NATIVE_ARRAY_PROTOTYPES", goog.TRUSTED_SITE), goog.define("goog.array.ASSUME_NATIVE_FUNCTIONS", !1), goog.array.ArrayLike, goog.array.peek = function(e) {
    return e[e.length - 1]
}, goog.array.last = goog.array.peek, goog.array.ARRAY_PROTOTYPE_ = Array.prototype, goog.array.indexOf = goog.NATIVE_ARRAY_PROTOTYPES && (goog.array.ASSUME_NATIVE_FUNCTIONS || goog.array.ARRAY_PROTOTYPE_.indexOf) ? function(e, o, t) {
    return goog.asserts.assert(null != e.length), goog.array.ARRAY_PROTOTYPE_.indexOf.call(e, o, t)
} : function(e, o, t) {
    ...
    goog.asserts.assert(null != e.length), goog.array.ARRAY_PROTOTYPE_.forEach.call(e, o, t)
} : function(e, o, t) {
    for (var r = e.length, g = goog.isString(e) ? e.split("") : e, n = 0; n < r; n++) n in g && o.call(t, g[n], n, e)
}, goog.array.forEachRight = function(e, o, t) {
    for (var r = e.length, g = goog.isString(e) ? e.split("") : e, n = r - 1; 0 <= n; --n) n in g && o.call(t, g[n], n, e)
    ...
    return goog.asserts.assert(null != e.length), goog.array.ARRAY_PROTOTYPE_.filter.call(e, o, t)
} : function(e, o, t) {
    ...
    return goog.asserts.assert(null != e.length), goog.array.ARRAY_PROTOTYPE_.map.call(e, o, t)
} : function(e, o, t) {
    for (var r = e.length, g = new Array(r), n = goog.isString(e) ? e.split("") : e, i = 0; i < r; i++) i in n && (g[i] = o.call(t, n[i], i, e));
    return g
    ...
    return goog.asserts.assert(null != e.length), r && (o = goog.bind(o, r)), goog.array.ARRAY_PROTOTYPE_.reduce.call(e, o, t)
} : function(t, r, e, g) {
    var n = e;
    ...
    return goog.asserts.assert(null != e.length), r && (o = goog.bind(o, r)), goog.array.ARRAY_PROTOTYPE_.reduceRight.call(e, o, t)
} : function(t, r, e, g) {
    var n = e;
    ...
    return goog.asserts.assert(null != e.length), goog.array.ARRAY_PROTOTYPE_.some.call(e, o, t)
} : function(e, o, t) {
    ...
    return goog.asserts.assert(null != e.length), goog.array.ARRAY_PROTOTYPE_.every.call(e, o, t)
} : function(e, o, t) {
    for (var r = e.length, g = goog.isString(e) ? e.split("") : e, n = 0; n < r; n++)
    ...
    return goog.asserts.assert(null != e.length), 1 == goog.array.ARRAY_PROTOTYPE_.splice.call(e, o, 1).length
}, goog.array.removeIf = function(e, o, t) {
    var r = goog.array.findIndex(e, o, t);
    return 0 <= r && (goog.array.removeAt(e, r), !0)
    ...
    return goog.asserts.assert(null != e.length), arguments.length <= 2 ? goog.array.ARRAY_PROTOTYPE_.slice.call(e, o) : goog.array.ARRAY_PROTOTYPE_.slice.call(e, o, t)
    ...
    for (var r = o || e, g = t || function(e) {
        ...
        var s = e[a++],
            l = g(s);
        Object.prototype.hasOwnProperty.call(n, l) || (n[l] = !0, r[i++] = s)
    }
    r.length = i
    ...
    for (var n, i = 0, a = e.length; i < a;) {
        var s, l = i + a >> 1;
        0 < (s = t ? o.call(g, e[l], l, e) : o(r, e[l])) ? i = 1 + l : (a = l, n = !s)
    }
    return n ? i : ~i
    ...
    for (var r = {}, g = 0; g < e.length; g++) {
        var n = e[g],
            i = o.call(t, n, g, e);
        if (goog.isDef(i))(r[i] || (r[i] = [])).push(n)
    }
    return r
    ...
    if (0 < i)
        for (var a = g; a < n; a += i) r.push(a);
    else
        for (a = g; n < a; a += i) r.push(a);
    return r
    ...
    for (var o = [], t = 0; t < arguments.length; t++) {
        ...
        if (goog.isArray(r))
            for (var g = 0; g < r.length; g += 8192)
                for (var n = goog.array.slice(r, g, g + 8192), i = goog.array.flatten.apply(null, n), a = 0; a < i.length; a++) o.push(i[a]);
        else o.push(r)
    }
    return o
}, goog.array.rotate = function(e, o) {
    return goog.asserts.assert(null != e.length), e.length && (0 < (o %= e.length) ? goog.array.ARRAY_PROTOTYPE_.unshift.apply(e, e.splice(-o, o)) : o < 0 && goog.array.ARRAY_PROTOTYPE_.push.apply(e, e.splice(0, -o))), e
}, goog.array.moveItem = function(e, o, t) {
    goog.asserts.assert(0 <= o && o < e.length), goog.asserts.assert(0 <= t && t < e.length);
    ...
    return r
}, goog.provide("goog.object"), goog.object.forEach = function(e, o, t) {
    for (var r in e) o.call(t, e[r], r, e)
}, goog.object.filter = function(e, o, t) {
    var r = {};
    for (var g in e) o.call(t, e[g], g, e) && (r[g] = e[g]);
    return r
}, goog.object.map = function(e, o, t) {
    var r = {};
    for (var g in e) r[g] = o.call(t, e[g], g, e);
    return r
    ...
    for (var t = goog.isArrayLike(o), r = t ? o : arguments, g = t ? 0 : 1; g < r.length && (e = e[r[g]], goog.isDef(e)); g++);
    return e
    ...
    for (var t, r, g = 1; g < arguments.length; g++) {
        ...
        for (var n = 0; n < goog.object.PROTOTYPE_FIELDS_.length; n++) t = goog.object.PROTOTYPE_FIELDS_[n], Object.prototype.hasOwnProperty.call(r, t) && (e[t] = r[t])
    }
    ...
    if (goog.labs.userAgent.browser.isOpera()) return g(["Version", "Opera", "OPR"]);
    if (goog.labs.userAgent.browser.isChrome()) return g(["Chrome", "CriOS"]);
    var n = o[2];
    return n && n[1] || ""
    ...
    return t && t[1] || ""
}, goog.provide("goog.labs.userAgent.platform"), goog.require("goog.labs.userAgent.util"), goog.require("goog.string"), goog.labs.userAgent.platform.isAndroid = function() {
...
}, goog.provide("goog.userAgent"), goog.require("goog.labs.userAgent.browser"), goog.require("goog.labs.userAgent.engine"), goog.require("goog.labs.userAgent.platform"), goog.require("goog.labs.userAgent.util"), goog.require("goog.string"), goog.define("goog.userAgent.ASSUME_IE", !1), goog.define("goog.userAgent.ASSUME_GECKO", !1), goog.define("goog.userAgent.ASSUME_WEBKIT", !1), goog.define("goog.userAgent.ASSUME_MOBILE_WEBKIT", !1), goog.define("goog.userAgent.ASSUME_OPERA", !1), goog.define("goog.userAgent.ASSUME_ANY_VERSION", !1), goog.userAgent.BROWSER_KNOWN_ = goog.userAgent.ASSUME_IE || goog.userAgent.ASSUME_GECKO || goog.userAgent.ASSUME_MOBILE_WEBKIT || goog.userAgent.ASSUME_WEBKIT || goog.userAgent.ASSUME_OPERA, goog.userAgent.getUserAgentString = function() {
    ...
    return e && e.platform || ""
}, goog.userAgent.PLATFORM = goog.userAgent.determinePlatform_(), goog.define("goog.userAgent.ASSUME_MAC", !1), goog.define("goog.userAgent.ASSUME_WINDOWS", !1), goog.define("goog.userAgent.ASSUME_LINUX", !1), goog.define("goog.userAgent.ASSUME_X11", !1), goog.define("goog.userAgent.ASSUME_ANDROID", !1), goog.define("goog.userAgent.ASSUME_IPHONE", !1), goog.define("goog.userAgent.ASSUME_IPAD", !1), goog.userAgent.PLATFORM_KNOWN_ = goog.userAgent.ASSUME_MAC || goog.userAgent.ASSUME_WINDOWS || goog.userAgent.ASSUME_LINUX || goog.userAgent.ASSUME_X11 || goog.userAgent.ASSUME_ANDROID || goog.userAgent.ASSUME_IPHONE || goog.userAgent.ASSUME_IPAD, goog.userAgent.MAC = goog.userAgent.PLATFORM_KNOWN_ ? goog.userAgent.ASSUME_MAC : goog.labs.userAgent.platform.isMacintosh(), goog.userAgent.WINDOWS = goog.userAgent.PLATFORM_KNOWN_ ? goog.userAgent.ASSUME_WINDOWS : goog.labs.userAgent.platform.isWindows(), goog.userAgent.isLegacyLinux_ = function() {
    ...
    if (t && (o = t ? t[1] : ""), goog.userAgent.IE && !goog.labs.userAgent.engine.isEdge()) {
        var r = goog.userAgent.getDocumentMode_();
        if (r > parseFloat(o)) return String(r)
    }
    return o
    ...
    if (e && goog.userAgent.IE && (o || !goog.labs.userAgent.engine.isEdge())) return o || ("CSS1Compat" == e.compatMode ? parseInt(goog.userAgent.VERSION, 10) : 5)
}(), goog.provide("goog.dom.BrowserFeature"), goog.require("goog.userAgent"), goog.dom.BrowserFeature = {
...
}, goog.provide("goog.dom.TagName"), goog.dom.TagName = {
    A: "A",
    ABBR: "ABBR",
    ACRONYM: "ACRONYM",
    ADDRESS: "ADDRESS",
    ...
    VIDEO: "VIDEO",
    WBR: "WBR"
}, goog.provide("goog.dom.tags"), goog.require("goog.object"), goog.dom.tags.VOID_TAGS_ = goog.object.createSet("area,base,br,col,command,embed,hr,img,input,keygen,link,meta,param,source,track,wbr".split(",")), goog.dom.tags.isVoidTag = function(e) {
    return !0 === goog.dom.tags.VOID_TAGS_[e]
}, goog.provide("goog.string.TypedString"), goog.string.TypedString = function() {}, goog.string.TypedString.prototype.implementsGoogStringTypedString, goog.string.TypedString.prototype.getTypedStringValue, goog.provide("goog.string.Const"), goog.require("goog.asserts"), goog.require("goog.string.TypedString"), goog.string.Const = function() {
...
}, goog.provide("goog.html.SafeStyle"), goog.require("goog.array"), goog.require("goog.asserts"), goog.require("goog.string"), goog.require("goog.string.Const"), goog.require("goog.string.TypedString"), goog.html.SafeStyle = function() {
    ...
    for (var t in e) {
        ...
        var r = e[t];
        null != r && (r instanceof goog.string.Const ? (r = goog.string.Const.unwrap(r), goog.asserts.assert(!/[{;}]/.test(r), "Value does not allow [{;}].")) : goog.html.SafeStyle.VALUE_RE_.test(r) ? goog.html.SafeStyle.hasBalancedQuotes_(r) || (goog.asserts.fail("String value requires balanced quotes, got: " + r), r = goog.html.SafeStyle.INNOCUOUS_STRING) : (goog.asserts.fail("String value allows only [-,.\"'%_!# a-zA-Z0-9], got: " + r), r = goog.html.SafeStyle.INNOCUOUS_STRING), o += t + ":" + r + ";")
    }
    ...
    return o && t
}, goog.html.SafeStyle.VALUE_RE_ = /^[-,."'%_!# a-zA-Z0-9]+$/, goog.html.SafeStyle.concat = function(e) {
    var o = "",
        t = function(e) {
...
}, goog.provide("goog.html.SafeStyleSheet"), goog.require("goog.array"), goog.require("goog.asserts"), goog.require("goog.string"), goog.require("goog.string.Const"), goog.require("goog.string.TypedString"), goog.html.SafeStyleSheet = function() {
...
}, goog.html.SafeStyleSheet.EMPTY = goog.html.SafeStyleSheet.createSafeStyleSheetSecurityPrivateDoNotAccessOrElse(""), goog.provide("goog.fs.url"), goog.fs.url.createObjectUrl = function(e) {
...
}, goog.i18n.bidi.ltrChars_ = "", goog.i18n.bidi.rtlChars_ = "", goog.i18n.bidi.htmlSkipReg_ = /<[^>]*>|&[^;]+;/g, goog.i18n.bidi.stripHtmlIfNeeded_ = function(e, o) {
...
}, goog.i18n.bidi.bracketGuardHtmlRe_ = /(\(.*?\)+)|(\[.*?\]+)|(\{.*?\}+)|(&lt;.*?(&gt;)+)/g, goog.i18n.bidi.bracketGuardTextRe_ = /(\(.*?\)+)|(\[.*?\]+)|(\{.*?\}+)|(<.*?>+)/g, goog.i18n.bidi.guardBracketInHtml = function(e, o) {
    ...
    for (var t = 0, r = 0, g = !1, n = goog.i18n.bidi.stripHtmlIfNeeded_(e, o).split(goog.i18n.bidi.wordSeparatorRe_), i = 0; i < n.length; i++) {
        var a = n[i];
        goog.i18n.bidi.startsWithRtl(a) ? (t++, r++) : goog.i18n.bidi.isRequiredLtrRe_.test(a) ? g = !0 : goog.i18n.bidi.hasAnyLtr(a) ? r++ : goog.i18n.bidi.hasNumeralsRe_.test(a) && (g = !0)
    }
...
}, goog.provide("goog.html.TrustedResourceUrl"), goog.require("goog.asserts"), goog.require("goog.i18n.bidi.Dir"), goog.require("goog.i18n.bidi.DirectionalString"), goog.require("goog.string.Const"), goog.require("goog.string.TypedString"), goog.html.TrustedResourceUrl = function() {
    ...
    for (var g = 0; g < e.length; g++) r += goog.html.SafeStyleSheet.unwrap(e[g]);
    ...
    if (t instanceof goog.string.Const) t = goog.string.Const.unwrap(t);
        ...
        if (o.toLowerCase() in goog.html.SafeHtml.URL_ATTRIBUTES_)
            if (t instanceof goog.html.TrustedResourceUrl) t = goog.html.TrustedResourceUrl.unwrap(t);
                ...
                if (!(t instanceof goog.html.SafeUrl)) throw Error('Attribute "' + o + '" on tag "' + e + '" requires goog.html.SafeUrl or goog.string.Const value, "' + t + '" given.');
    ...
    var r = goog.i18n.bidi.Dir.NEUTRAL,
        g = "",
        n = function(e) {
            if (goog.isArray(e)) goog.array.forEach(e, n);
            else {
                var o = goog.html.SafeHtml.htmlEscape(e);
    ...
    return goog.array.forEach(arguments, n), goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(g, r)
    ...
    var a = t;
    if (goog.isDefAndNotNull(a) ? goog.isArray(a) || (a = [a]) : a = [], goog.dom.tags.isVoidTag(e.toLowerCase())) goog.asserts.assert(!a.length, "Void tag <" + e + "> does not allow content."), g += ">";
    else {
        var s = goog.html.SafeHtml.concat(a);
        g += ">" + goog.html.SafeHtml.unwrap(s) + "</" + e + ">", r = s.getDirection()
    }
    var l = o && o.dir;
    return l && (r = /^(ltr|rtl|auto)$/i.test(l) ? goog.i18n.bidi.Dir.NEUTRAL : null), goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(g, r)
}, goog.html.SafeHtml.combineAttributes = function(e, o, t) {
    var r, g = {};
    for (r in e) goog.asserts.assert(r.toLowerCase() == r, "Must be lower case"), g[r] = e[r];
    for (r in o) goog.asserts.assert(r.toLowerCase() == r, "Must be lower case"), g[r] = o[r];
    for (r in t) {
        var n = r.toLowerCase();
        if (n in e) throw Error('Cannot override "' + n + '" attribute, got "' + r + '" with value "' + t[r] + '"');
        n in o && delete g[n], g[r] = t[r]
    }
    return g
}, goog.html.SafeHtml.DOCTYPE_HTML = goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse("<!DOCTYPE html>", goog.i18n.bidi.Dir.NEUTRAL), goog.html.SafeHtml.EMPTY = goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse("", goog.i18n.bidi.Dir.NEUTRAL), goog.provide("goog.dom.safe"), goog.provide("goog.dom.safe.InsertAdjacentHtmlPosition"), goog.require("goog.asserts"), goog.require("goog.html.SafeHtml"), goog.require("goog.html.SafeUrl"), goog.require("goog.html.TrustedResourceUrl"), goog.require("goog.string"), goog.require("goog.string.Const"), goog.dom.safe.InsertAdjacentHtmlPosition = {
    ...
    var t;
    t = o instanceof goog.html.SafeUrl ? o : goog.html.SafeUrl.sanitize(o), e.href = goog.html.SafeUrl.unwrap(t)
    ...
    e.rel = t, goog.string.caseInsensitiveContains(t, "stylesheet") ? (goog.asserts.assert(o instanceof goog.html.TrustedResourceUrl, 'URL must be TrustedResourceUrl because "rel" contains "stylesheet"'), e.href = goog.html.TrustedResourceUrl.unwrap(o)) : o instanceof goog.html.TrustedResourceUrl ? e.href = goog.html.TrustedResourceUrl.unwrap(o) : o instanceof goog.html.SafeUrl ? e.href = goog.html.SafeUrl.unwrap(o) : e.href = goog.html.SafeUrl.sanitize(o).getTypedStringValue()
    ...
    var n;
    return n = e instanceof goog.html.SafeUrl ? e : goog.html.SafeUrl.sanitize(e), (o || window).open(goog.html.SafeUrl.unwrap(n), t ? goog.string.Const.unwrap(t) : "", r, g)
}, goog.provide("goog.math"), goog.require("goog.array"), goog.require("goog.asserts"), goog.math.randomInt = function(e) {
    ...
    return 180 < t ? t -= 360 : t <= -180 && (t = 360 + t), t
    ...
    for (var g = o || function(e, o) {
            ...
            return t[e]
        }, i = t.length, a = e.length, s = [], l = 0; l < i + 1; l++) s[l] = [], s[l][0] = 0;
    for (var u = 0; u < a + 1; u++) s[0][u] = 0;
    for (l = 1; l <= i; l++)
        for (u = 1; u <= a; u++) g(t[l - 1], e[u - 1]) ? s[l][u] = s[l - 1][u - 1] + 1 : s[l][u] = Math.max(s[l - 1][u], s[l][u - 1]);
    var c = [];
    for (l = i, u = a; 0 < l && 0 < u;) g(t[l - 1], e[u - 1]) ? (c.unshift(n(l - 1, u - 1)), l--, u--) : s[l - 1][u] > s[l][u - 1] ? l-- : u--;
    return c
...
}, goog.provide("goog.math.Coordinate"), goog.require("goog.math"), goog.math.Coordinate = function(e, o) {
    ...
    return e instanceof goog.math.Coordinate ? (this.x += e.x, this.y += e.y) : (this.x += e, goog.isNumber(o) && (this.y += o)), this
    ...
    var t = o || new goog.math.Coordinate(0, 0),
        ...
        n = Math.cos(e),
        i = Math.sin(e);
    this.x = (r - t.x) * n - (g - t.y) * i + t.x, this.y = (r - t.x) * i + (g - t.y) * n + t.y
}, goog.math.Coordinate.prototype.rotateDegrees = function(e, o) {
    this.rotateRadians(goog.math.toRadians(e), o)
}, goog.provide("goog.math.Size"), goog.math.Size = function(e, o) {
...
}, goog.dom.$ = goog.dom.getElement, goog.dom.getElementsByTagNameAndClass = function(e, o, t) {
    ...
    if (t && g.getElementsByClassName) {
        ...
        if (n) {
            for (var s = {}, l = 0, u = 0; c = a[u]; u++) n == c.nodeName && (s[l++] = c);
            return s.length = l, s
        }
        return a
    }
    ...
    return a
}, goog.dom.$$ = goog.dom.getElementsByTagNameAndClass, goog.dom.setProperties = function(t, e) {
    ...
    if (o) {
        ...
        if (goog.dom.isCss1CompatMode_(o) && g.scrollHeight) t = g.scrollHeight != n ? g.scrollHeight : g.offsetHeight;
        else {
            var i = g.scrollHeight,
                a = g.offsetHeight;
            g.clientHeight != a && (i = r.scrollHeight, a = r.offsetHeight), t = n < i ? a < i ? i : a : i < a ? i : a
        }
    }
    return t
    ...
    if (!goog.dom.BrowserFeature.CAN_ADD_NAME_OR_TYPE_ATTRIBUTES && r && (r.name || r.type)) {
        var g = ["<", t];
        if (r.name && g.push(' name="', goog.string.htmlEscape(r.name), '"'), r.type) {
            g.push(' type="', goog.string.htmlEscape(r.type), '"');
            var n = {};
            goog.object.extend(n, r), delete n.type, r = n
        }
        g.push(">"), t = g.join("")
    }
    var i = e.createElement(t);
    return r && (goog.isString(r) ? i.className = r : goog.isArray(r) ? i.className = r.join(" ") : goog.dom.setProperties(i, r)), 2 < o.length && goog.dom.append_(e, i, o, 2), i
...
goog.dom.createTextNode = function(e) {
    ...
    for (var g = e.createElement(goog.dom.TagName.TABLE), n = g.appendChild(e.createElement(goog.dom.TagName.TBODY)), i = 0; i < o; i++) {
        for (var a = e.createElement(goog.dom.TagName.TR), s = 0; s < t; s++) {
            ...
            r && goog.dom.setTextContent(l, goog.string.Unicode.NBSP), a.appendChild(l)
        }
        n.appendChild(a)
    }
    return g
    ...
    return goog.dom.BrowserFeature.INNER_HTML_NEEDS_SCOPED_ELEMENT ? (goog.dom.safe.setInnerHtml(t, goog.html.SafeHtml.concat(goog.html.SafeHtml.create("br"), o)), t.removeChild(t.firstChild)) : goog.dom.safe.setInnerHtml(t, o), goog.dom.childrenToNode_(e, t)
    ...
    var t = e.createElement(goog.dom.TagName.DIV);
    return goog.dom.BrowserFeature.INNER_HTML_NEEDS_SCOPED_ELEMENT ? (t.innerHTML = "<br>" + o, t.removeChild(t.firstChild)) : t.innerHTML = o, goog.dom.childrenToNode_(e, t)
    ...
    return (i = s.createRange()).selectNode(e), i.collapse(!0), (a = s.createRange()).selectNode(o), a.collapse(!0), i.compareBoundaryPoints(goog.global.Range.START_TO_END, a)
    ...
    var r = [],
        g = 1 / 0;
    for (o = 0; o < t; o++) {
        for (var n = [], i = arguments[o]; i;) n.unshift(i), i = i.parentNode;
    ...
    var o;
    if (goog.dom.BrowserFeature.CAN_USE_INNER_TEXT && "innerText" in e) o = goog.string.canonicalizeNewlines(e.innerText);
    else {
        var t = [];
    ...
    for (var t = o || goog.dom.getOwnerDocument(e).body, r = []; e && e != t;) {
        for (var g = e; g = g.previousSibling;) r.unshift(goog.dom.getTextContent(g));
        e = e.parentNode
    }
    ...
    } else if (n.nodeName in goog.dom.PREDEFINED_TAG_VALUES_) g += goog.dom.PREDEFINED_TAG_VALUES_[n.nodeName].length;
    else
        for (var i = n.childNodes.length - 1; 0 <= i; i--) r.push(n.childNodes[i]);
    return goog.isObject(t) && (t.remainder = n ? n.nodeValue.length + o - g - 1 : 0, t.node = n), n
...
}, goog.dom.DomHelper.prototype.$ = goog.dom.DomHelper.prototype.getElement, goog.dom.DomHelper.prototype.getElementsByTagNameAndClass = function(e, o, t) {
...
}, goog.provide("goog.async.FreeList"), goog.async.FreeList = goog.defineClass(null, {
...
}), goog.provide("goog.async.WorkItem"), goog.provide("goog.async.WorkQueue"), goog.require("goog.asserts"), goog.require("goog.async.FreeList"), goog.async.WorkQueue = function() {
    this.workHead_ = null, this.workTail_ = null
}, goog.define("goog.async.WorkQueue.DEFAULT_MAX_UNUSED", 100), goog.async.WorkQueue.freelist_ = new goog.async.FreeList(function() {
    ...
    this.fn = null, this.scope = null, this.next = null
}, goog.provide("goog.debug.EntryPointMonitor"), goog.provide("goog.debug.entryPointRegistry"), goog.require("goog.asserts"), goog.debug.EntryPointMonitor = function() {}, goog.debug.EntryPointMonitor.prototype.wrap, goog.debug.EntryPointMonitor.prototype.unwrap, goog.debug.entryPointRegistry.refList_ = [], goog.debug.entryPointRegistry.monitors_ = [], goog.debug.entryPointRegistry.monitorsMayExist_ = !1, goog.debug.entryPointRegistry.register = function(e) {
    ...
    for (var t = goog.bind(e.unwrap, e), r = 0; r < goog.debug.entryPointRegistry.refList_.length; r++) goog.debug.entryPointRegistry.refList_[r](t);
    o.length--
}, goog.provide("goog.functions"), goog.functions.constant = function(e) {
    return function() {
        return e
    }
...
}, goog.provide("goog.async.nextTick"), goog.provide("goog.async.throwException"), goog.require("goog.debug.entryPointRegistry"), goog.require("goog.dom.TagName"), goog.require("goog.functions"), goog.require("goog.labs.userAgent.browser"), goog.require("goog.labs.userAgent.engine"), goog.async.throwException = function(e) {
    goog.global.setTimeout(function() {
        throw e
    }, 0)
}, goog.async.nextTick = function(e, o, t) {
    var r = e;
    o && (r = goog.bind(e, o)), r = goog.async.nextTick.wrapCallback_(r), !goog.isFunction(goog.global.setImmediate) || !t && goog.global.Window && goog.global.Window.prototype && goog.global.Window.prototype.setImmediate == goog.global.setImmediate ? (goog.async.nextTick.setImmediate_ || (goog.async.nextTick.setImmediate_ = goog.async.nextTick.getSetImmediateEmulator_()), goog.async.nextTick.setImmediate_(r)) : goog.global.setImmediate(r)
    ...
    if (void 0 === e && "undefined" != typeof window && window.postMessage && window.addEventListener && !goog.labs.userAgent.engine.isPresto() && (e = function() {
            ...
            o.addEventListener("message", n, !1), this.port1 = {}, this.port2 = {
                postMessage: function() {
                    o.postMessage(r, g)
                }
            }
        }), void 0 === e || goog.labs.userAgent.browser.isIE()) return "undefined" != typeof document && "onreadystatechange" in document.createElement(goog.dom.TagName.SCRIPT) ? function(e) {
    ...
    return o.port1.onmessage = function() {
        ...
        function(e) {
            r.next = {
                cb: e
            }, r = r.next, o.port2.postMessage(0)
        }
...
}), goog.provide("goog.testing.watchers"), goog.testing.watchers.resetWatchers_ = [], goog.testing.watchers.signalClockReset = function() {
    for (var e = goog.testing.watchers.resetWatchers_, o = 0; o < e.length; o++) goog.testing.watchers.resetWatchers_[o]()
}, goog.testing.watchers.watchClockReset = function(e) {
    goog.testing.watchers.resetWatchers_.push(e)
}, goog.provide("goog.async.run"), goog.require("goog.async.WorkQueue"), goog.require("goog.async.nextTick"), goog.require("goog.async.throwException"), goog.require("goog.testing.watchers"), goog.async.run = function(e, o) {
...
}, goog.async.run.schedule_, goog.async.run.workQueueScheduled_ = !1, goog.async.run.workQueue_ = new goog.async.WorkQueue, goog.DEBUG && (goog.async.run.resetQueue_ = function() {
...
}, goog.provide("goog.promise.Resolver"), goog.promise.Resolver = function() {}, goog.promise.Resolver.prototype.promise, goog.promise.Resolver.prototype.resolve, goog.promise.Resolver.prototype.reject, goog.provide("goog.Promise"), goog.require("goog.Thenable"), goog.require("goog.asserts"), goog.require("goog.async.FreeList"), goog.require("goog.async.run"), goog.require("goog.async.throwException"), goog.require("goog.debug.Error"), goog.require("goog.promise.Resolver"), goog.Promise = function(e, o) {
    if (this.state_ = goog.Promise.State_.PENDING, this.result_ = void 0, this.parent_ = null, this.callbackEntries_ = null, this.callbackEntriesTail_ = null, this.executing_ = !1, 0 < goog.Promise.UNHANDLED_REJECTION_DELAY ? this.unhandledRejectionId_ = 0 : 0 == goog.Promise.UNHANDLED_REJECTION_DELAY && (this.hadUnhandledRejection_ = !1), goog.Promise.LONG_STACK_TRACES && (this.stack_ = [], this.addStackTrace_(new Error("created")), this.currentStep_ = 0), e == goog.Promise.RESOLVE_FAST_PATH_) this.resolve_(goog.Promise.State_.FULFILLED, o);
    else try {
        var t = this;
        e.call(o, function(e) {
...
}, goog.define("goog.Promise.LONG_STACK_TRACES", !1), goog.define("goog.Promise.UNHANDLED_REJECTION_DELAY", 0), goog.Promise.State_ = {
    PENDING: 0,
    BLOCKED: 1,
    FULFILLED: 2,
    REJECTED: 3
...
}, goog.define("goog.Promise.DEFAULT_MAX_UNUSED", 100), goog.Promise.freelist_ = new goog.async.FreeList(function() {
    ...
    return new goog.Promise(function(t, o) {
        ...
        if (r) {
            ...
            for (var i, a = 0; i = s[a]; a++) goog.Promise.maybeThenVoid_(i, goog.partial(e, a), n)
        } else t(g)
    })
    ...
    return new goog.Promise(function(r, e) {
        ...
        if (g) {
            ...
            for (var t, i = 0; t = a[i]; i++) goog.Promise.maybeThenVoid_(t, goog.partial(o, i, !0), goog.partial(o, i, !1))
        } else r(n)
    })
    ...
    return new goog.Promise(function(o, t) {
        ...
        if (r) {
            ...
            for (var i, a = 0; i = s[a]; a++) goog.Promise.maybeThenVoid_(i, e, goog.partial(n, a))
        } else o(void 0)
    })
    ...
    return goog.Promise.LONG_STACK_TRACES && this.addStackTrace_(new Error("thenCatch")), this.addChildPromise_(null, e, o)
    ...
    if (this.callbackEntries_) {
        for (var t = 0, r = null, g = null, n = this.callbackEntries_; n && (n.always || (t++, n.child == e && (r = n), !(r && 1 < t))); n = n.next) r || (g = n);
        r && (this.state_ == goog.Promise.State_.PENDING && 1 == t ? this.cancelInternal_(o) : (g ? this.removeEntryAfter_(g) : this.popEntry_(), this.executeCallback_(r, goog.Promise.State_.REJECTED, o)))
    }
    ...
    }), (e.child.parent_ = this).addCallbackEntry_(e), e.child
    ...
    if (this.state_ == goog.Promise.State_.PENDING) {
        if (this == t) o = goog.Promise.State_.REJECTED, t = new TypeError("Promise cannot resolve to itself");
        else {
            if (goog.Thenable.isImplementedBy(t)) return t = t, this.state_ = goog.Promise.State_.BLOCKED, void goog.Promise.maybeThenVoid_(t, this.unblockAndFulfill_, this.unblockAndReject_, this);
        ...
        this.result_ = t, this.state_ = o, this.parent_ = null, this.scheduleCallbacks_(), o != goog.Promise.State_.REJECTED || t instanceof goog.Promise.CancellationError || goog.Promise.addUnhandledRejection_(this, t)
    }
    ...
    if (goog.Promise.LONG_STACK_TRACES && goog.isString(e.stack)) {
        var o = e.stack.split("\n", 4)[3],
            t = e.message;
        t += Array(11 - t.length).join(" "), this.stack_.push(t + o)
    }
    ...
    this.disposed_ ? e.call(o) : (this.onDisposeCallbacks_ || (this.onDisposeCallbacks_ = []), this.onDisposeCallbacks_.push(goog.isDef(o) ? goog.bind(e, o) : e))
...
}, goog.provide("goog.events.EventId"), goog.events.EventId = function(e) {
    this.id = e
}, goog.events.EventId.prototype.toString = function() {
    return this.id
}, goog.provide("goog.events.Event"), goog.provide("goog.events.EventLike"), goog.require("goog.Disposable"), goog.require("goog.events.EventId"), goog.events.EventLike, goog.events.Event = function(e, o) {
    ...
    e.preventDefault()
}, goog.provide("goog.events.EventType"), goog.require("goog.userAgent"), goog.events.getVendorPrefixedName_ = function(e) {
...
}, goog.provide("goog.reflect"), goog.reflect.object = function(e, o) {
    return o
    ...
    return !1
}, goog.provide("goog.events.BrowserEvent"), goog.provide("goog.events.BrowserEvent.MouseButton"), goog.require("goog.events.BrowserFeature"), goog.require("goog.events.Event"), goog.require("goog.events.EventType"), goog.require("goog.reflect"), goog.require("goog.userAgent"), goog.events.BrowserEvent = function(e, o) {
    ...
    r ? goog.userAgent.GECKO && (goog.reflect.canAccessProperty(r, "nodeName") || (r = null)) : t == goog.events.EventType.MOUSEOVER ? r = e.fromElement : t == goog.events.EventType.MOUSEOUT && (r = e.toElement), this.relatedTarget = r, this.offsetX = goog.userAgent.WEBKIT || void 0 !== e.offsetX ? e.offsetX : e.layerX, this.offsetY = goog.userAgent.WEBKIT || void 0 !== e.offsetY ? e.offsetY : e.layerY, this.clientX = void 0 !== e.clientX ? e.clientX : e.pageX, this.clientY = void 0 !== e.clientY ? e.clientY : e.pageY, this.screenX = e.screenX || 0, this.screenY = e.screenY || 0, this.button = e.button, this.keyCode = e.keyCode || 0, this.charCode = e.charCode || ("keypress" == t ? e.keyCode : 0), this.ctrlKey = e.ctrlKey, this.altKey = e.altKey, this.shiftKey = e.shiftKey, this.metaKey = e.metaKey, this.platformModifierKey = goog.userAgent.MAC ? e.metaKey : e.ctrlKey, this.state = e.state, (this.event_ = e).defaultPrevented && this.preventDefault()
    ...
    return this.event_
}, goog.provide("goog.events.Listenable"), goog.provide("goog.events.ListenableKey"), goog.require("goog.events.EventId"), goog.events.Listenable = function() {}, goog.events.Listenable.IMPLEMENTED_BY_PROP = "closure_listenable_" + (1e6 * Math.random() | 0), goog.events.Listenable.addImplementation = function(e) {
    ...
    goog.events.Listener.ENABLE_MONITORING && (this.creationStack = (new Error).stack), this.listener = e, this.proxy = o, this.src = t, this.type = r, this.capture = !!g, this.handler = n, this.key = goog.events.ListenableKey.reserveKey(), this.callOnce = !1, this.removed = !1
...
}, goog.provide("goog.events.ListenerMap"), goog.require("goog.array"), goog.require("goog.events.Listener"), goog.require("goog.object"), goog.events.ListenerMap = function(e) {
    this.src = e, this.listeners = {}, this.typeCount_ = 0
}, goog.events.ListenerMap.prototype.getTypeCount = function() {
    return this.typeCount_
}, goog.events.ListenerMap.prototype.getListenerCount = function() {
    var e = 0;
    for (var o in this.listeners) e += this.listeners[o].length;
    return e
}, goog.events.ListenerMap.prototype.add = function(e, o, t, r, g) {
    var n, i = e.toString(),
        a = this.listeners[i];
    a || (a = this.listeners[i] = [], this.typeCount_++);
    var s = goog.events.ListenerMap.findListenerIndex_(a, o, r, g);
    return -1 < s ? (n = a[s], t || (n.callOnce = !1)) : ((n = new goog.events.Listener(o, null, this.src, i, !!r, g)).callOnce = t, a.push(n)), n
    ...
    return -1 < i && (n[i].markAsRemoved(), goog.array.removeAt(n, i), 0 == n.length && (delete this.listeners[g], this.typeCount_--), !0)
    ...
    for (var r in this.listeners)
        if (!o || r == o) {
            for (var g = this.listeners[r], n = 0; n < g.length; n++) ++t, g[n].markAsRemoved();
    ...
    var g = this.listeners[e.toString()],
        n = -1;
    return g && (n = goog.events.ListenerMap.findListenerIndex_(g, o, t, r)), -1 < n ? g[n] : null
    ...
    for (var g = 0; g < e.length; ++g) {
        var n = e[g];
        if (!n.removed && n.listener == o && n.capture == !!t && n.handler == r) return g
    }
    return -1
    ...
    OFF_AND_SILENT: 1,
    ON: 2
}, goog.define("goog.events.CAPTURE_SIMULATION_MODE", 2), goog.events.listenerCountEstimate_ = 0, goog.events.listen = function(e, o, t, r, g) {
    if (goog.isArray(o)) {
        for (var n = 0; n < o.length; n++) goog.events.listen(e, o[n], t, r, g);
        return null
    }
    return t = goog.events.wrapListener(t), goog.events.Listenable.isImplementedBy(e) ? e.listen(o, t, r, g) : goog.events.listen_(e, o, t, !1, r, g)
    ...
    if ((s.proxy = l).src = e, l.listener = s, e.addEventListener) e.addEventListener(o.toString(), l, i);
    else {
    ...
    return goog.events.listenerCountEstimate_++, s
    ...
    if (goog.isArray(o)) {
        for (var n = 0; n < o.length; n++) goog.events.listenOnce(e, o[n], t, r, g);
        return null
    }
    return t = goog.events.wrapListener(t), goog.events.Listenable.isImplementedBy(e) ? e.listenOnce(o, t, r, g) : goog.events.listen_(e, o, t, !0, r, g)
    ...
    if (t = goog.events.wrapListener(t), goog.events.Listenable.isImplementedBy(e)) return e.unlisten(o, t, r, g);
    if (!e) return !1;
    var i = !!r,
        a = goog.events.getListenerMap_(e);
    if (a) {
        var s = a.getListener(o, t, i, g);
        if (s) return goog.events.unlistenByKey(s)
    }
    return !1
    ...
    var r = o.type,
        g = o.proxy;
    t.removeEventListener ? t.removeEventListener(r, g, o.capture) : t.detachEvent && t.detachEvent(goog.events.getOnString_(r), g), goog.events.listenerCountEstimate_--;
    var n = goog.events.getListenerMap_(t);
    return n ? (n.removeByKey(o), 0 == n.getTypeCount() && (n.src = null, t[goog.events.LISTENER_MAP_PROP_] = null)) : o.markAsRemoved(), !0
    ...
    for (var n in t.listeners)
        if (!g || n == g)
            for (var i = t.listeners[n].concat(), a = 0; a < i.length; ++a) goog.events.unlistenByKey(i[a]) && ++r;
    return r
    ...
    o = o, t = goog.events.wrapListener(t);
    var n = !!r;
    if (goog.events.Listenable.isImplementedBy(e)) return e.getListener(o, t, n, g);
    if (!e) return null;
    ...
    var o = [];
    for (var t in e) e[t] && e[t].id ? o.push(t + " = " + e[t] + " (" + e[t].id + ")") : o.push(t + " = " + e[t]);
    return o.join("\n")
    ...
    if (goog.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT) return goog.events.fireListener(e, new goog.events.BrowserEvent(o, this));
    ...
    if (goog.events.CAPTURE_SIMULATION_MODE == goog.events.CaptureSimulationMode.ON) {
        if (!goog.events.isMarkedIeEvent_(t)) {
            ...
            for (var n = [], i = r.currentTarget; i; i = i.parentNode) n.push(i);
    ...
    } else g = goog.events.fireListener(e, r);
    return g
...
}, goog.events.LISTENER_WRAPPER_PROP_ = "__closure_events_fn_" + (1e9 * Math.random() >>> 0), goog.events.wrapListener = function(o) {
    return goog.asserts.assert(o, "Listener can not be null."), goog.isFunction(o) ? o : (goog.asserts.assert(o.handleEvent, "An object listener must have handleEvent method."), o[goog.events.LISTENER_WRAPPER_PROP_] || (o[goog.events.LISTENER_WRAPPER_PROP_] = function(e) {
...
}), goog.provide("goog.events.EventTarget"), goog.require("goog.Disposable"), goog.require("goog.asserts"), goog.require("goog.events"), goog.require("goog.events.Event"), goog.require("goog.events.Listenable"), goog.require("goog.events.ListenerMap"), goog.require("goog.object"), goog.events.EventTarget = function() {
    goog.Disposable.call(this), this.eventTargetListeners_ = new goog.events.ListenerMap(this), (this.actualEventTarget_ = this).parentEventTarget_ = null
    ...
    if (t) {
        o = [];
        for (var r = 1; t; t = t.getParentEventTarget()) o.push(t), goog.asserts.assert(++r < goog.events.EventTarget.MAX_ANCESTORS_, "infinite loop")
    }
    ...
    return this.assertInitialized_(), this.eventTargetListeners_.add(String(e), o, !1, t, r)
    ...
    for (var g = !0, n = 0; n < r.length; ++n) {
        ...
        if (i && !i.removed && i.capture == o) {
            var a = i.listener,
                s = i.handler || i.src;
            i.callOnce && this.unlistenByKey(i), g = !1 !== a.call(s, t) && g
        }
    }
    ...
    if (goog.isString(o)) o = new goog.events.Event(o, e);
        ...
        var g = o;
        o = new goog.events.Event(r, e), goog.object.extend(o, g)
    }
    var n, i = !0;
    if (t)
        for (var a = t.length - 1; !o.propagationStopped_ && 0 <= a; a--) i = (n = o.currentTarget = t[a]).fireListeners(r, !0, o) && i;
    if (o.propagationStopped_ || (i = (n = o.currentTarget = e).fireListeners(r, !0, o) && i, o.propagationStopped_ || (i = n.fireListeners(r, !1, o) && i)), t)
        for (a = 0; !o.propagationStopped_ && a < t.length; a++) i = (n = o.currentTarget = t[a]).fireListeners(r, !1, o) && i;
    return i
}, goog.provide("goog.Timer"), goog.require("goog.Promise"), goog.require("goog.events.EventTarget"), goog.Timer = function(e, o) {
    ...
    if (this.enabled) {
        ...
        if (0 < e && e < this.interval_ * goog.Timer.intervalScale) return void(this.timer_ = this.timerObject_.setTimeout(this.boundTick_, this.interval_ - e));
        this.timer_ && (this.timerObject_.clearTimeout(this.timer_), this.timer_ = null), this.dispatchTick(), this.enabled && (this.timer_ = this.timerObject_.setTimeout(this.boundTick_, this.interval_), this.last_ = goog.now())
    }
...
}, goog.provide("goog.json"), goog.provide("goog.json.Replacer"), goog.provide("goog.json.Reviver"), goog.provide("goog.json.Serializer"), goog.define("goog.json.USE_NATIVE_JSON", !1), goog.json.isValid = function(e) {
    ...
    "\t": "\\t",
    "\v": "\\u000b"
}, goog.json.Serializer.charsToReplace_ = /\uffff/.test("ï¿¿") ? /[\\\"\x00-\x1f\x7f-\uffff]/g : /[\\\"\x00-\x1f\x7f-\xff]/g, goog.json.Serializer.prototype.serializeString_ = function(e, o) {
    ...
    for (var r = "", g = 0; g < t; g++) {
        o.push(r);
        var n = e[g];
        this.serializeInternal(this.replacer_ ? this.replacer_.call(e, String(g), n) : n, o), r = ","
    }
    o.push("]")
    ...
    for (var r in e)
        if (Object.prototype.hasOwnProperty.call(e, r)) {
            var g = e[r];
            "function" != typeof g && (o.push(t), this.serializeString_(r, o), o.push(":"), this.serializeInternal(this.replacer_ ? this.replacer_.call(e, r, g) : g, o), t = ",")
        } o.push("}")
    ...
    return goog.asserts.assertString(goog.string.Const.unwrap(e), "must provide justification"), goog.asserts.assert(!goog.string.isEmpty(goog.string.Const.unwrap(e)), "must provide non-empty justification"), goog.html.SafeScript.createSafeScriptSecurityPrivateDoNotAccessOrElse(o)
...
}, goog.provide("goog.structs"), goog.require("goog.array"), goog.require("goog.object"), goog.structs.getCount = function(e) {
    ...
    if ("function" == typeof e.forEach) e.forEach(o, t);
        ...
        for (var r = goog.structs.getKeys(e), g = goog.structs.getValues(e), n = g.length, i = 0; i < n; i++) o.call(t, g[i], r && r[i], e)
    ...
    var r, g = goog.structs.getKeys(e),
        n = goog.structs.getValues(e),
        i = n.length;
    if (g) {
        r = {};
        for (var a = 0; a < i; a++) o.call(t, n[a], g[a], e) && (r[g[a]] = n[a])
    } else {
        r = [];
        for (a = 0; a < i; a++) o.call(t, n[a], void 0, e) && r.push(n[a])
    }
    return r
    ...
    if (g) {
        r = {};
        for (var a = 0; a < i; a++) r[g[a]] = o.call(t, n[a], g[a], e)
    } else {
        r = [];
        for (a = 0; a < i; a++) r[a] = o.call(t, n[a], void 0, e)
    }
    return r
    ...
    return !0
}, goog.provide("goog.structs.Collection"), goog.structs.Collection = function() {}, goog.structs.Collection.prototype.add, goog.structs.Collection.prototype.remove, goog.structs.Collection.prototype.contains, goog.structs.Collection.prototype.getCount, goog.provide("goog.iter"), goog.provide("goog.iter.Iterable"), goog.provide("goog.iter.Iterator"), goog.provide("goog.iter.StopIteration"), goog.require("goog.array"), goog.require("goog.asserts"), goog.require("goog.functions"), goog.require("goog.math"), goog.iter.Iterable, goog.iter.StopIteration = "StopIteration" in goog.global ? goog.global.StopIteration : {
    ...
    var r = 0,
        g = e,
        n = t || 1;
    if (1 < arguments.length && (r = e, g = o), 0 == n) throw Error("Range step argument must not be zero");
    var i = new goog.iter.Iterator;
    return i.next = function() {
        if (0 < n && g <= r || n < 0 && r <= g) throw goog.iter.StopIteration;
        var e = r;
        return r += n, e
    }, i
    ...
    return g.next = function() {
        for (;;) {
            var e = r.next();
            if (!n || !o.call(t, e, void 0, r)) return n = !1, e
        }
    }, g
    ...
    return goog.isNumber(t) && (goog.asserts.assert(goog.math.isInt(t) && o <= t), r = goog.iter.limit(r, t - o)), r
...
}, goog.provide("goog.structs.Map"), goog.require("goog.iter.Iterator"), goog.require("goog.iter.StopIteration"), goog.require("goog.object"), goog.structs.Map = function(e, o) {
    ...
    var o, t;
    t = e instanceof goog.structs.Map ? (o = e.getKeys(), e.getValues()) : (o = goog.object.getKeys(e), goog.object.getValues(e));
    ...
    return e.next = function() {
        if (r != g.version_) throw Error("The map has changed since the iterator was created");
...
}, goog.provide("goog.structs.Set"), goog.require("goog.structs"), goog.require("goog.structs.Collection"), goog.require("goog.structs.Map"), goog.structs.Set = function(e) {
    ...
    var s = [],
        l = function(e, o, t) {
            ...
            try {
                if (goog.isDef(e))
                    if (goog.isNull(e)) s.push("NULL");
                    else if (goog.isString(e)) s.push('"' + r(e) + '"');
                else if (goog.isFunction(e)) s.push(r(String(e)));
                else if (goog.isObject(e))
                    if (n.contains(e)) s.push("*** reference loop detected ***");
                    else {
                        for (var i in n.add(e), s.push("{"), e) !a && goog.isFunction(e[i]) || (s.push("\n"), s.push(g), s.push(i + " = "), l(e[i], g, n));
                        s.push("\n" + o + "}")
                    }
                else s.push(e);
                else s.push("undefined")
            } catch (e) {
                s.push("*** " + e + " ***")
            }
        };
    return l(e, "", new goog.structs.Set), s.join("")
    ...
    if (goog.isDefAndNotNull(e) || (e = ""), !/^https?:\/\//i.test(e)) return goog.html.SafeUrl.fromConstant(goog.string.Const.from("sanitizedviewsrc"));
    ...
    var t;
    if ("string" == typeof e ? (t = Error(e), Error.captureStackTrace && Error.captureStackTrace(t, goog.debug.enhanceError)) : t = e, t.stack || (t.stack = goog.debug.getStacktrace(goog.debug.enhanceError)), o) {
    ...
    return e && e <= g ? t.push("[...reached max depth limit...]") : t.push("[end]"), t.join("")
    ...
    if (goog.array.contains(o, e)) t.push("[...circular reference...]");
        ...
        for (var r = e.arguments, g = 0; r && g < r.length; g++) {
            ...
            40 < n.length && (n = n.substr(0, 40) + "..."), t.push(n)
        }
        o.push(e), t.push(")\n");
        try {
    ...
    return e instanceof Function ? e.displayName || e.name || "unknown type name" : e instanceof Object ? e.constructor.displayName || e.constructor.name || Object.prototype.toString.call(e) : null === e ? "null" : typeof e
}, goog.debug.fnNameCache_ = {}, goog.debug.fnNameResolver_, goog.provide("goog.debug.LogRecord"), goog.debug.LogRecord = function(e, o, t, r, g) {
    this.reset(e, o, t, r, g)
}, goog.debug.LogRecord.prototype.time_, goog.debug.LogRecord.prototype.level_, goog.debug.LogRecord.prototype.msg_, goog.debug.LogRecord.prototype.loggerName_, goog.debug.LogRecord.prototype.sequenceNumber_ = 0, goog.debug.LogRecord.prototype.exception_ = null, goog.define("goog.debug.LogRecord.ENABLE_SEQUENCE_NUMBERS", !0), goog.debug.LogRecord.nextSequenceNumber_ = 0, goog.debug.LogRecord.prototype.reset = function(e, o, t, r, g) {
    goog.debug.LogRecord.ENABLE_SEQUENCE_NUMBERS && (this.sequenceNumber_ = "number" == typeof g ? g : goog.debug.LogRecord.nextSequenceNumber_++), this.time_ = r || goog.now(), this.level_ = e, this.msg_ = o, this.loggerName_ = t, delete this.exception_
...
}, goog.provide("goog.debug.LogBuffer"), goog.require("goog.asserts"), goog.require("goog.debug.LogRecord"), goog.debug.LogBuffer = function() {
...
}, goog.define("goog.debug.LogBuffer.CAPACITY", 0), goog.debug.LogBuffer.prototype.buffer_, goog.debug.LogBuffer.prototype.curIndex_, goog.debug.LogBuffer.prototype.isFull_, goog.debug.LogBuffer.prototype.addRecord = function(e, o, t) {
    ...
    return this.isFull_ = r == goog.debug.LogBuffer.CAPACITY - 1, this.buffer_[r] = new goog.debug.LogRecord(e, o, t)
}, goog.debug.LogBuffer.isBufferingEnabled = function() {
    return 0 < goog.debug.LogBuffer.CAPACITY
}, goog.debug.LogBuffer.prototype.clear = function() {
    this.buffer_ = new Array(goog.debug.LogBuffer.CAPACITY), this.curIndex_ = -1, this.isFull_ = !1
}, goog.debug.LogBuffer.prototype.forEachRecord = function(e) {
    var o = this.buffer_;
    if (o[0])
        for (var t = this.curIndex_, r = this.isFull_ ? t : -1; e(o[r = (r + 1) % goog.debug.LogBuffer.CAPACITY]), r != t;);
}, goog.provide("goog.debug.LogManager"), goog.provide("goog.debug.Loggable"), goog.provide("goog.debug.Logger"), goog.provide("goog.debug.Logger.Level"), goog.require("goog.array"), goog.require("goog.asserts"), goog.require("goog.debug"), goog.require("goog.debug.LogBuffer"), goog.require("goog.debug.LogRecord"), goog.debug.Loggable, goog.debug.Logger = function(e) {
    this.name_ = e, this.parent_ = null, this.level_ = null, this.children_ = null, this.handlers_ = null
}, goog.debug.Logger.ROOT_LOGGER_NAME = "", goog.define("goog.debug.Logger.ENABLE_HIERARCHY", !0), goog.debug.Logger.ENABLE_HIERARCHY || (goog.debug.Logger.rootHandlers_ = [], goog.debug.Logger.rootLevel_), goog.debug.Logger.Level = function(e, o) {
    ...
    if (goog.debug.LogBuffer.isBufferingEnabled()) var r = goog.debug.LogBuffer.getInstance().addRecord(e, o, this.name_);
    else r = new goog.debug.LogRecord(e, String(o), this.name_);
    return t && r.setException(t), r
    ...
    if (goog.debug.Logger.logToProfilers("log:" + e.getMessage()), goog.debug.Logger.ENABLE_HIERARCHY)
        ...
        for (var t, r = 0; t = goog.debug.Logger.rootHandlers_[r++];) t(e)
...
goog.debug.LogManager.getLoggers = function() {
...
}, goog.provide("goog.net.ErrorCode"), goog.net.ErrorCode = {
    NO_ERROR: 0,
    ACCESS_DENIED: 1,
    FILE_NOT_FOUND: 2,
    FF_SILENT_ERROR: 3,
...
}, goog.provide("goog.net.EventType"), goog.net.EventType = {
    COMPLETE: "complete",
    SUCCESS: "success",
    ERROR: "error",
    ABORT: "abort",
    ...
    PROGRESS: "progress"
}, goog.provide("goog.net.HttpStatus"), goog.net.HttpStatus = {
    CONTINUE: 100,
...
}, goog.provide("goog.net.XhrLike"), goog.net.XhrLike = function() {}, goog.net.XhrLike.OrNative, goog.net.XhrLike.prototype.onreadystatechange, goog.net.XhrLike.prototype.responseText, goog.net.XhrLike.prototype.responseXML, goog.net.XhrLike.prototype.readyState, goog.net.XhrLike.prototype.status, goog.net.XhrLike.prototype.statusText, goog.net.XhrLike.prototype.open = function(e, o, t, r, g) {}, goog.net.XhrLike.prototype.send = function(e) {}, goog.net.XhrLike.prototype.abort = function() {}, goog.net.XhrLike.prototype.setRequestHeader = function(e, o) {}, goog.net.XhrLike.prototype.getResponseHeader = function(e) {}, goog.net.XhrLike.prototype.getAllResponseHeaders = function() {}, goog.provide("goog.net.XmlHttpFactory"), goog.require("goog.net.XhrLike"), goog.net.XmlHttpFactory = function() {}, goog.net.XmlHttpFactory.prototype.cachedOptions_ = null, goog.net.XmlHttpFactory.prototype.createInstance = goog.abstractMethod, goog.net.XmlHttpFactory.prototype.getOptions = function() {
    return this.cachedOptions_ || (this.cachedOptions_ = this.internalGetOptions())
}, goog.net.XmlHttpFactory.prototype.internalGetOptions = goog.abstractMethod, goog.provide("goog.net.WrapperXmlHttpFactory"), goog.require("goog.net.XhrLike"), goog.require("goog.net.XmlHttpFactory"), goog.net.WrapperXmlHttpFactory = function(e, o) {
    goog.net.XmlHttpFactory.call(this), this.xhrFactory_ = e, this.optionsFactory_ = o
}, goog.inherits(goog.net.WrapperXmlHttpFactory, goog.net.XmlHttpFactory), goog.net.WrapperXmlHttpFactory.prototype.createInstance = function() {
    return this.xhrFactory_()
}, goog.net.WrapperXmlHttpFactory.prototype.getOptions = function() {
    return this.optionsFactory_()
}, goog.provide("goog.net.DefaultXmlHttpFactory"), goog.provide("goog.net.XmlHttp"), goog.provide("goog.net.XmlHttp.OptionType"), goog.provide("goog.net.XmlHttp.ReadyState"), goog.provide("goog.net.XmlHttpDefines"), goog.require("goog.asserts"), goog.require("goog.net.WrapperXmlHttpFactory"), goog.require("goog.net.XmlHttpFactory"), goog.net.XmlHttp = function() {
    return goog.net.XmlHttp.factory_.createInstance()
}, goog.define("goog.net.XmlHttp.ASSUME_NATIVE_XHR", !1), goog.net.XmlHttpDefines = {}, goog.define("goog.net.XmlHttpDefines.ASSUME_NATIVE_XHR", !1), goog.net.XmlHttp.getOptions = function() {
    ...
    INTERACTIVE: 3,
    COMPLETE: 4
}, goog.net.XmlHttp.factory_, goog.net.XmlHttp.setFactory = function(e, o) {
...
}, goog.inherits(goog.net.DefaultXmlHttpFactory, goog.net.XmlHttpFactory), goog.net.DefaultXmlHttpFactory.prototype.createInstance = function() {
    var e = this.getProgId_();
    return e ? new ActiveXObject(e) : new XMLHttpRequest
}, goog.net.DefaultXmlHttpFactory.prototype.internalGetOptions = function() {
    var e = {};
    return this.getProgId_() && (e[goog.net.XmlHttp.OptionType.USE_NULL_FUNCTION] = !0, e[goog.net.XmlHttp.OptionType.LOCAL_REQUEST_ERROR] = !0), e
}, goog.net.DefaultXmlHttpFactory.prototype.ieProgId_, goog.net.DefaultXmlHttpFactory.prototype.getProgId_ = function() {
    if (goog.net.XmlHttp.ASSUME_NATIVE_XHR || goog.net.XmlHttpDefines.ASSUME_NATIVE_XHR) return "";
    if (this.ieProgId_ || "undefined" != typeof XMLHttpRequest || "undefined" == typeof ActiveXObject) return this.ieProgId_;
...
}, goog.net.XmlHttp.setGlobalFactory(new goog.net.DefaultXmlHttpFactory), goog.provide("goog.uri.utils"), goog.provide("goog.uri.utils.ComponentIndex"), goog.provide("goog.uri.utils.QueryArray"), goog.provide("goog.uri.utils.QueryValue"), goog.provide("goog.uri.utils.StandardQueryParam"), goog.require("goog.asserts"), goog.require("goog.string"), goog.require("goog.userAgent"), goog.uri.utils.CharCode_ = {
    AMPERSAND: 38,
    EQUAL: 61,
    HASH: 35,
    QUESTION: 63
    ...
    var a = "";
    return e && (a += e + ":"), t && (a += "//", o && (a += o + "@"), a += t, r && (a += ":" + r)), g && (a += g), n && (a += "?" + n), i && (a += "#" + i), a
}, goog.uri.utils.splitRe_ = new RegExp("^(?:([^:/?#.]+):)?(?://(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#(.*))?$"), goog.uri.utils.ComponentIndex = {
    SCHEME: 1,
    USER_INFO: 2,
    DOMAIN: 3,
    PORT: 4,
    ...
    return goog.uri.utils.phishingProtection_(), e.match(goog.uri.utils.splitRe_)
    ...
    if (goog.uri.utils.needsPhishingProtection_) {
        ...
        if (e) {
            ...
            if (o) {
                ...
                if (t && t != e.hostname) throw goog.uri.utils.needsPhishingProtection_ = !0, Error()
            }
        }
    }
    ...
    if (goog.DEBUG && (0 <= e.indexOf("#") || 0 <= e.indexOf("?"))) throw Error("goog.uri.utils: Fragment or query identifiers are not supported: [" + e + "]")
}, goog.uri.utils.QueryValue, goog.uri.utils.QueryArray, goog.uri.utils.parseQueryData = function(e, o) {
    for (var t = e.split("&"), r = 0; r < t.length; r++) {
        var g = t[r].indexOf("="),
            n = null,
            i = null;
        0 <= g ? (n = t[r].substring(0, g), i = t[r].substring(g + 1)) : n = t[r], o(n, i ? goog.string.urlDecode(i) : "")
    }
}, goog.uri.utils.appendQueryData_ = function(e) {
    if (e[1]) {
        var o = e[0],
            t = o.indexOf("#");
        0 <= t && (e.push(o.substr(t)), e[0] = o = o.substr(0, t));
        var r = o.indexOf("?");
    ...
    if (goog.isArray(o)) {
        ...
        for (var r = 0; r < o.length; r++) goog.uri.utils.appendKeyValuePairs_(e, String(o[r]), t)
    } else null != o && t.push("&", e, "" === o ? "" : "=", goog.string.urlEncode(o))
    ...
    for (var r = t || 0; r < o.length; r += 2) goog.uri.utils.appendKeyValuePairs_(o[r], o[r + 1], e);
    return e
    ...
    var r = [e, "&", o];
    return goog.isDefAndNotNull(t) && r.push("=", goog.string.urlEncode(t)), goog.uri.utils.appendQueryData_(r)
    ...
    for (var g = o, n = t.length; 0 <= (g = e.indexOf(t, g)) && g < r;) {
        ...
        if (i == goog.uri.utils.CharCode_.AMPERSAND || i == goog.uri.utils.CharCode_.QUESTION) {
            ...
            if (!a || a == goog.uri.utils.CharCode_.EQUAL || a == goog.uri.utils.CharCode_.AMPERSAND || a == goog.uri.utils.CharCode_.HASH) return g
        }
        g += n + 1
    }
    return -1
}, goog.uri.utils.hashOrEndRe_ = /#|$/, goog.uri.utils.hasParam = function(e, o) {
    ...
    if (r < 0) return null;
    var g = e.indexOf("&", r);
    return (g < 0 || t < g) && (g = t), r += o.length + 1, goog.string.urlDecode(e.substr(r, g - r))
}, goog.uri.utils.getParamValues = function(e, o) {
    for (var t, r = e.search(goog.uri.utils.hashOrEndRe_), g = 0, n = []; 0 <= (t = goog.uri.utils.findParam_(e, g, o, r));)((g = e.indexOf("&", t)) < 0 || r < g) && (g = r), t += o.length + 1, n.push(goog.string.urlDecode(e.substr(t, g - t)));
    return n
}, goog.uri.utils.trailingQueryPunctuationRe_ = /[?&]($|#)/, goog.uri.utils.removeParam = function(e, o) {
    for (var t, r = e.search(goog.uri.utils.hashOrEndRe_), g = 0, n = []; 0 <= (t = goog.uri.utils.findParam_(e, g, o, r));) n.push(e.substring(g, t)), g = Math.min(e.indexOf("&", t) + 1 || r, r);
    return n.push(e.substr(g)), n.join("").replace(goog.uri.utils.trailingQueryPunctuationRe_, "$1")
    ...
    return goog.uri.utils.assertNoFragmentsOrQueries_(e), goog.string.endsWith(e, "/") && (e = e.substr(0, e.length - 1)), goog.string.startsWith(o, "/") && (o = o.substr(1)), goog.string.buildString(e, "/", o)
...
}, goog.provide("goog.net.XhrIo"), goog.provide("goog.net.XhrIo.ResponseType"), goog.require("goog.Timer"), goog.require("goog.array"), goog.require("goog.debug.entryPointRegistry"), goog.require("goog.events.EventTarget"), goog.require("goog.json"), goog.require("goog.log"), goog.require("goog.net.ErrorCode"), goog.require("goog.net.EventType"), goog.require("goog.net.HttpStatus"), goog.require("goog.net.XmlHttp"), goog.require("goog.object"), goog.require("goog.string"), goog.require("goog.structs"), goog.require("goog.structs.Map"), goog.require("goog.uri.utils"), goog.require("goog.userAgent"), goog.forwardDeclare("goog.Uri"), goog.net.XhrIo = function(e) {
    goog.net.XhrIo.base(this, "constructor"), this.headers = new goog.structs.Map, this.xmlHttpFactory_ = e || null, this.active_ = !1, this.xhr_ = null, this.xhrOptions_ = null, this.lastUri_ = "", this.lastMethod_ = "", this.lastErrorCode_ = goog.net.ErrorCode.NO_ERROR, this.lastError_ = "", this.errorDispatched_ = !1, this.inSend_ = !1, this.inOpen_ = !1, this.inAbort_ = !1, this.timeoutInterval_ = 0, this.timeoutId_ = null, this.responseType_ = goog.net.XhrIo.ResponseType.DEFAULT, this.withCredentials_ = !1, this.useXhr2Timeout_ = !1
    ...
    if (this.xhr_) throw Error("[goog.net.XhrIo] Object is active with another request=" + this.lastUri_ + "; newUri=" + e);
    var g = o ? o.toUpperCase() : "GET";
    this.lastUri_ = e, this.lastError_ = "", this.lastErrorCode_ = goog.net.ErrorCode.NO_ERROR, this.lastMethod_ = g, this.errorDispatched_ = !1, this.active_ = !0, this.xhr_ = this.createXhr(), this.xhrOptions_ = this.xmlHttpFactory_ ? this.xmlHttpFactory_.getOptions() : goog.net.XmlHttp.getOptions(), this.xhr_.onreadystatechange = goog.bind(this.onReadyStateChange_, this);
    try {
        goog.log.fine(this.logger_, this.formatMsg_("Opening Xhr")), this.inOpen_ = !0, this.xhr_.open(g, String(e), !0), this.inOpen_ = !1
    } catch (e) {
        return goog.log.fine(this.logger_, this.formatMsg_("Error opening Xhr: " + e.message)), void this.error_(goog.net.ErrorCode.EXCEPTION, e)
    }
    var n = t || "",
    ...
    !goog.array.contains(goog.net.XhrIo.METHODS_WITH_FORM_DATA, g) || a || s || i.set(goog.net.XhrIo.CONTENT_TYPE_HEADER, goog.net.XhrIo.FORM_CONTENT_TYPE), i.forEach(function(e, o) {
        this.xhr_.setRequestHeader(o, e)
    }, this), this.responseType_ && (this.xhr_.responseType = this.responseType_), goog.object.containsKey(this.xhr_, "withCredentials") && (this.xhr_.withCredentials = this.withCredentials_);
    try {
        this.cleanUpTimeoutTimer_(), 0 < this.timeoutInterval_ && (this.useXhr2Timeout_ = goog.net.XhrIo.shouldUseXhr2Timeout_(this.xhr_), goog.log.fine(this.logger_, this.formatMsg_("Will abort after " + this.timeoutInterval_ + "ms if incomplete, xhr2 " + this.useXhr2Timeout_)), this.useXhr2Timeout_ ? (this.xhr_[goog.net.XhrIo.XHR2_TIMEOUT_] = this.timeoutInterval_, this.xhr_[goog.net.XhrIo.XHR2_ON_TIMEOUT_] = goog.bind(this.timeout_, this)) : this.timeoutId_ = goog.Timer.callOnce(this.timeout_, this.timeoutInterval_, this)), goog.log.fine(this.logger_, this.formatMsg_("Sending request")), this.inSend_ = !0, this.xhr_.send(n), this.inSend_ = !1
    } catch (e) {
    ...
    void 0 === goog || this.xhr_ && (this.lastError_ = "Timed out after " + this.timeoutInterval_ + "ms, aborting", this.lastErrorCode_ = goog.net.ErrorCode.TIMEOUT, goog.log.fine(this.logger_, this.formatMsg_(this.lastError_)), this.dispatchEvent(goog.net.EventType.TIMEOUT), this.abort(goog.net.ErrorCode.TIMEOUT))
}, goog.net.XhrIo.prototype.error_ = function(e, o) {
    this.active_ = !1, this.xhr_ && (this.inAbort_ = !0, this.xhr_.abort(), this.inAbort_ = !1), this.lastError_ = o, this.lastErrorCode_ = e, this.dispatchErrors_(), this.cleanUpXhr_()
}, goog.net.XhrIo.prototype.dispatchErrors_ = function() {
    this.errorDispatched_ || (this.errorDispatched_ = !0, this.dispatchEvent(goog.net.EventType.COMPLETE), this.dispatchEvent(goog.net.EventType.ERROR))
}, goog.net.XhrIo.prototype.abort = function(e) {
    this.xhr_ && this.active_ && (goog.log.fine(this.logger_, this.formatMsg_("Aborting")), this.active_ = !1, this.inAbort_ = !0, this.xhr_.abort(), this.inAbort_ = !1, this.lastErrorCode_ = e || goog.net.ErrorCode.ABORT, this.dispatchEvent(goog.net.EventType.COMPLETE), this.dispatchEvent(goog.net.EventType.ABORT), this.cleanUpXhr_())
}, goog.net.XhrIo.prototype.disposeInternal = function() {
    this.xhr_ && (this.active_ && (this.active_ = !1, this.inAbort_ = !0, this.xhr_.abort(), this.inAbort_ = !1), this.cleanUpXhr_(!0)), goog.net.XhrIo.base(this, "disposeInternal")
    ...
    if (this.active_)
        if (void 0 === goog);
        else if (this.xhrOptions_[goog.net.XmlHttp.OptionType.LOCAL_REQUEST_ERROR] && this.getReadyState() == goog.net.XmlHttp.ReadyState.COMPLETE && 2 == this.getStatus()) goog.log.fine(this.logger_, this.formatMsg_("Local request error detected and ignored"));
    else {
        if (this.inSend_ && this.getReadyState() == goog.net.XmlHttp.ReadyState.COMPLETE) return void goog.Timer.callOnce(this.onReadyStateChange_, 0, this);
        if (this.dispatchEvent(goog.net.EventType.READY_STATE_CHANGE), this.isComplete()) {
            goog.log.fine(this.logger_, this.formatMsg_("Request complete")), this.active_ = !1;
            try {
    ...
    if (this.xhr_) {
        ...
        this.xhr_ = null, this.xhrOptions_ = null, e || this.dispatchEvent(goog.net.EventType.READY);
        try {
    ...
    this.xhr_ && this.useXhr2Timeout_ && (this.xhr_[goog.net.XhrIo.XHR2_ON_TIMEOUT_] = null), goog.isNumber(this.timeoutId_) && (goog.Timer.clear(this.timeoutId_), this.timeoutId_ = null)
    ...
    if (this.xhr_) {
        ...
        return e && 0 == o.indexOf(e) && (o = o.substring(e.length)), goog.json.parse(o)
    }
    ...
    try {
        ...
        return goog.log.error(this.logger_, "Response type " + this.responseType_ + " is not supported on this browser"), null
    } catch (e) {
...
}), goog.provide("goog.Uri"), goog.provide("goog.Uri.QueryData"), goog.require("goog.array"), goog.require("goog.string"), goog.require("goog.structs"), goog.require("goog.structs.Map"), goog.require("goog.uri.utils"), goog.require("goog.uri.utils.ComponentIndex"), goog.require("goog.uri.utils.StandardQueryParam"), goog.Uri = function(e, o) {
    var t;
    this.scheme_ = "", this.userInfo_ = "", this.domain_ = "", this.port_ = null, this.path_ = "", this.fragment_ = "", this.isReadOnly_ = !1, this.ignoreCase_ = !1, this.queryData_, e instanceof goog.Uri ? (this.ignoreCase_ = goog.isDef(o) ? o : e.getIgnoreCase(), this.setScheme(e.getScheme()), this.setUserInfo(e.getUserInfo()), this.setDomain(e.getDomain()), this.setPort(e.getPort()), this.setPath(e.getPath()), this.setQueryData(e.getQueryData().clone()), this.setFragment(e.getFragment())) : e && (t = goog.uri.utils.split(String(e))) ? (this.ignoreCase_ = !!o, this.setScheme(t[goog.uri.utils.ComponentIndex.SCHEME] || "", !0), this.setUserInfo(t[goog.uri.utils.ComponentIndex.USER_INFO] || "", !0), this.setDomain(t[goog.uri.utils.ComponentIndex.DOMAIN] || "", !0), this.setPort(t[goog.uri.utils.ComponentIndex.PORT]), this.setPath(t[goog.uri.utils.ComponentIndex.PATH] || "", !0), this.setQueryData(t[goog.uri.utils.ComponentIndex.QUERY_DATA] || "", !0), this.setFragment(t[goog.uri.utils.ComponentIndex.FRAGMENT] || "", !0)) : (this.ignoreCase_ = !!o, this.queryData_ = new goog.Uri.QueryData(null, null, this.ignoreCase_))
    ...
    if (t) {
        ...
        r && e.push(goog.Uri.encodeSpecialChars_(r, goog.Uri.reDisallowedInSchemeOrUserInfo_, !0), "@"), e.push(goog.Uri.removeDoubleEncoding_(goog.string.urlEncode(t)));
        var g = this.getPort();
        null != g && e.push(":", String(g))
    }
    var n = this.getPath();
    n && (this.hasDomain() && "/" != n.charAt(0) && e.push("/"), e.push(goog.Uri.encodeSpecialChars_(n, "/" == n.charAt(0) ? goog.Uri.reDisallowedInAbsolutePath_ : goog.Uri.reDisallowedInRelativePath_, !0)));
    var i = this.getEncodedQuery();
    i && e.push("?", i);
    var a = this.getFragment();
    return a && e.push("#", goog.Uri.encodeSpecialChars_(a, goog.Uri.reDisallowedInFragment_)), e.join("")
}, goog.Uri.prototype.resolve = function(e) {
    var o = this.clone(),
        t = e.hasScheme();
    t ? o.setScheme(e.getScheme()) : t = e.hasUserInfo(), t ? o.setUserInfo(e.getUserInfo()) : t = e.hasDomain(), t ? o.setDomain(e.getDomain()) : t = e.hasPort();
    var r = e.getPath();
    if (t) o.setPort(e.getPort());
    else if (t = e.hasPath()) {
        if ("/" != r.charAt(0))
            if (this.hasDomain() && !this.hasPath()) r = "/" + r;
            else {
                var g = o.getPath().lastIndexOf("/"); - 1 != g && (r = o.getPath().substr(0, g + 1) + r)
            } r = goog.Uri.removeDotSegments(r)
    }
    return t ? o.setPath(r) : t = e.hasQuery(), t ? o.setQueryData(e.getDecodedQuery()) : t = e.hasFragment(), t && o.setFragment(e.getFragment()), o
}, goog.Uri.prototype.clone = function() {
    return new goog.Uri(this)
}, goog.Uri.prototype.getScheme = function() {
    return this.scheme_
}, goog.Uri.prototype.setScheme = function(e, o) {
    return this.enforceReadOnly(), this.scheme_ = o ? goog.Uri.decodeOrEmpty_(e, !0) : e, this.scheme_ && (this.scheme_ = this.scheme_.replace(/:$/, "")), this
}, goog.Uri.prototype.hasScheme = function() {
    return !!this.scheme_
}, goog.Uri.prototype.getUserInfo = function() {
    return this.userInfo_
}, goog.Uri.prototype.setUserInfo = function(e, o) {
    return this.enforceReadOnly(), this.userInfo_ = o ? goog.Uri.decodeOrEmpty_(e) : e, this
}, goog.Uri.prototype.hasUserInfo = function() {
    return !!this.userInfo_
}, goog.Uri.prototype.getDomain = function() {
    return this.domain_
}, goog.Uri.prototype.setDomain = function(e, o) {
    return this.enforceReadOnly(), this.domain_ = o ? goog.Uri.decodeOrEmpty_(e, !0) : e, this
    ...
    return this.enforceReadOnly(), this.path_ = o ? goog.Uri.decodeOrEmpty_(e, !0) : e, this
}, goog.Uri.prototype.hasPath = function() {
    return !!this.path_
}, goog.Uri.prototype.hasQuery = function() {
    return "" !== this.queryData_.toString()
}, goog.Uri.prototype.setQueryData = function(e, o) {
    return this.enforceReadOnly(), e instanceof goog.Uri.QueryData ? (this.queryData_ = e, this.queryData_.setIgnoreCase(this.ignoreCase_)) : (o || (e = goog.Uri.encodeSpecialChars_(e, goog.Uri.reDisallowedInQuery_)), this.queryData_ = new goog.Uri.QueryData(e, null, this.ignoreCase_)), this
    ...
    return this.enforceReadOnly(), goog.isArray(o) || (o = [String(o)]), this.queryData_.setValues(e, o), this
    ...
    return this.enforceReadOnly(), this.fragment_ = o ? goog.Uri.decodeOrEmpty_(e) : e, this
    ...
    return e && s.setScheme(e), o && s.setUserInfo(o), t && s.setDomain(t), r && s.setPort(r), g && s.setPath(g), n && s.setQueryData(n), i && s.setFragment(i), s
}, goog.Uri.resolve = function(e, o) {
    return e instanceof goog.Uri || (e = goog.Uri.parse(e)), o instanceof goog.Uri || (o = goog.Uri.parse(o)), e.resolve(o)
    ...
    if (goog.string.contains(e, "./") || goog.string.contains(e, "/.")) {
        for (var o = goog.string.startsWith(e, "/"), t = e.split("/"), r = [], g = 0; g < t.length;) {
            var n = t[g++];
            "." == n ? o && g == t.length && r.push("") : ".." == n ? ((1 < r.length || 1 == r.length && "" != r[0]) && r.pop(), o && g == t.length && r.push("")) : (r.push(n), o = !0)
        }
        return r.join("/")
    }
    return e
    ...
    if (goog.isString(e)) {
        ...
        return t && (r = goog.Uri.removeDoubleEncoding_(r)), r
    }
    return null
...
}, goog.Uri.reDisallowedInSchemeOrUserInfo_ = /[#\/\?@]/g, goog.Uri.reDisallowedInRelativePath_ = /[\#\?:]/g, goog.Uri.reDisallowedInAbsolutePath_ = /[\#\?]/g, goog.Uri.reDisallowedInQuery_ = /[\#\?@]/g, goog.Uri.reDisallowedInFragment_ = /#/g, goog.Uri.haveSameDomain = function(e, o) {
    var t = goog.uri.utils.split(e),
        r = goog.uri.utils.split(o);
    ...
    this.keyMap_ = null, this.count_ = null, this.encodedQuery_ = e || null, this.ignoreCase_ = !!t
    ...
    for (var g = new goog.Uri.QueryData(null, null, r), n = 0; n < e.length; n++) g.add(e[n], o[n]);
    return g
    ...
    this.ensureKeyMapInitialized_();
    var o = [];
    if (goog.isString(e)) this.containsKey(e) && (o = goog.array.concat(o, this.keyMap_.get(this.getKeyName_(e))));
    else
        for (var t = this.keyMap_.getValues(), r = 0; r < t.length; r++) o = goog.array.concat(o, t[r]);
    return o
}, goog.Uri.QueryData.prototype.set = function(e, o) {
    return this.ensureKeyMapInitialized_(), this.invalidateCache_(), e = this.getKeyName_(e), this.containsKey(e) && (this.count_ -= this.keyMap_.get(e).length), this.keyMap_.set(e, [o]), this.count_++, this
    ...
    this.remove(e), 0 < o.length && (this.invalidateCache_(), this.keyMap_.set(this.getKeyName_(e), goog.array.clone(o)), this.count_ += o.length)
    ...
    for (var e = [], o = this.keyMap_.getKeys(), t = 0; t < o.length; t++)
        for (var r = o[t], g = goog.string.urlEncode(r), n = this.getValues(r), i = 0; i < n.length; i++) {
            var a = g;
            "" !== n[i] && (a += "=" + goog.string.urlEncode(n[i])), e.push(a)
        }
    ...
    return this.ensureKeyMapInitialized_(), this.keyMap_.forEach(function(e, o) {
    ...
    var o = String(e);
    return this.ignoreCase_ && (o = o.toLowerCase()), o
}, goog.Uri.QueryData.prototype.setIgnoreCase = function(e) {
    e && !this.ignoreCase_ && (this.ensureKeyMapInitialized_(), this.invalidateCache_(), this.keyMap_.forEach(function(e, o) {
        var t = o.toLowerCase();
...
function setCachedService(e, o) {
    ...
    if (t) {
        ...
        t.ServicePort = e, t.ServiceHost = o
    } else if (areCookiesEnabled()) {
        if (!e || !o) return setCookie("ServicePort", "", 100), void setCookie("ServiceHost", "", 100);
...
function ajaxSync(e, o, t) {
    var r, g = function() {
            ...
            for (var e, o = ["MSXML2.XmlHttp.6.0", "MSXML2.XmlHttp.5.0", "MSXML2.XmlHttp.4.0", "MSXML2.XmlHttp.3.0", "MSXML2.XmlHttp.2.0", "Microsoft.XmlHttp"], t = 0; t < o.length; t++) try {
        ...
        n = [],
        i = null;
    for (var a in o) n.push(encodeURIComponent(a) + "=" + encodeURIComponent(o[a]));
    if ("POST" == t ? i = n.length ? n.join("&") : "" : e += n.length ? "?" + n.join("&") : "", g.open(t || "GET", e, !1), "POST" == t && g.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), g.send(i), 200 != g.status) throw r = g.responseText.split(":", 1)[0], new Error(r + "\n\n" + g.responseText + ": " + g.statusText);
...
function asyncFindWebService(o, e) {
    var t = getCachedService(),
        r = t.Port,
        g = t.Host;
    traceMsg("checkEnvironment > cachedWebPort : " + g + "/" + r), traceMsg("checkEnvironment > trying async service discovery");
    ...
    if (r) {
        ...
        goog.net.XhrIo.send(i, function(e) {
            e.target.isSuccess() ? o() : (setCachedService(null, null), _findWebService(WS_SVC_HOST, o, n))
        }, "GET", void 0, void 0, WS_CHECK_TIMEOUT)
    } else _findWebService(WS_SVC_HOST, o, n)
}
...
function syncCheckWebService(t, e) {
    var o = getCachedService(),
        r = o.Port,
        g = o.Host;
    traceMsg("checkEnvironment > cachedWebPort : " + g + "/" + r), traceMsg("checkEnvironment > trying synchronous service discovery");

    function n(e, o) {
        traceMsg("checkEnvironment > web service found at :" + o + "/" + e), setCachedService(e, o), t(), dymo.label.framework.currentFramework || _createFramework.resetFramework()
    }
    var i = r || WS_START_PORT,
        a = g || WS_SVC_HOST,
        s = a === WS_SVC_HOST;
    checkServiceStatus(i, a) ? n(i, a) : s && checkServiceStatus(i, WS_SVC_HOST_LEGACY) ? n(i, WS_SVC_HOST_LEGACY) : (setCachedService(null, null), e())
}
...
function _findWebService(o, t, r) {
    for (var e = [], g = WS_START_PORT; g <= WS_END_PORT; ++g) e.push(getAjaxPromise(g, o));
...
function invokeWsCommandAsync(r, a, g) {
    ...
    return new goog.Promise(function(n, i) {
        var e = [],
            o = null;
        for (var t in g) e.push(encodeURIComponent(t) + "=" + encodeURIComponent(g[t]));
        "POST" == r ? o = e.length ? e.join("&") : "" : s += e.length ? "?" + e.join("&") : "", goog.net.XhrIo.send(s, function(e) {
            var o = e.target,
                t = null;
            if (o.isSuccess()) {
                var r = o.getResponse();
                ...
                traceMsg("invokeWsCommandAsync > " + g), i(new Error(g))
            }
...
goog.require("goog.dom"), goog.require("goog.net.XhrIo"), goog.require("goog.structs.Map"), goog.require("goog.Uri.QueryData"), goog.provide("dymo.label.framework"), goog.exportProperty(goog.Promise.prototype, "thenCatch", goog.Promise.prototype.thenCatch), goog.provide("dymo.label.framework.FlowDirection"), goog.provide("dymo.label.framework.LabelWriterPrintQuality"), goog.provide("dymo.label.framework.TwinTurboRoll"), goog.provide("dymo.label.framework.TapeAlignment"), goog.provide("dymo.label.framework.TapeCutMode"), goog.provide("dymo.label.framework.AddressBarcodePosition"), dymo.label.framework.FlowDirection = {}, dymo.label.framework.FlowDirection.LeftToRight = "LeftToRight", dymo.label.framework.FlowDirection.RightToLeft = "RightToLeft", dymo.label.framework.LabelWriterPrintQuality = {}, dymo.label.framework.LabelWriterPrintQuality.Auto = "Auto", dymo.label.framework.LabelWriterPrintQuality.Text = "Text", dymo.label.framework.LabelWriterPrintQuality.BarcodeAndGraphics = "BarcodeAndGraphics", dymo.label.framework.TwinTurboRoll = {}, dymo.label.framework.TwinTurboRoll.Auto = "Auto", dymo.label.framework.TwinTurboRoll.Left = "Left", dymo.label.framework.TwinTurboRoll.Right = "Right", dymo.label.framework.TapeAlignment = {}, dymo.label.framework.TapeAlignment.Center = "Center", dymo.label.framework.TapeAlignment.Left = "Left", dymo.label.framework.TapeAlignment.Right = "Right", dymo.label.framework.TapeCutMode = {}, dymo.label.framework.TapeCutMode.AutoCut = "AutoCut", dymo.label.framework.TapeCutMode.ChainMarks = "ChainMarks", dymo.label.framework.AddressBarcodePosition = {}, dymo.label.framework.AddressBarcodePosition.AboveAddress = "AboveAddress", dymo.label.framework.AddressBarcodePosition.BelowAddress = "BelowAddress", dymo.label.framework.AddressBarcodePosition.Suppress = "Suppress", dymo.label.framework.PrintJobStatus = {}, dymo.label.framework.PrintJobStatus.Unknown = 0, dymo.label.framework.PrintJobStatus.Printing = 1, dymo.label.framework.PrintJobStatus.Finished = 2, dymo.label.framework.PrintJobStatus.Error = 3, dymo.label.framework.PrintJobStatus.PaperOut = 4, dymo.label.framework.PrintJobStatus.InQueue = 5, dymo.label.framework.PrintJobStatus.ProcessingError = -1, dymo.label.framework.PrintJobStatus.PrinterBusy = -2, dymo.label.framework.PrintJobStatus.InvalidJobId = -3, dymo.label.framework.PrintJobStatus.NotSpooled = -4, goog.provide("goog.dom.xml"), goog.require("goog.dom"), goog.require("goog.dom.NodeType"), goog.dom.xml.MAX_XML_SIZE_KB = 2048, goog.dom.xml.MAX_ELEMENT_DEPTH = 256, goog.dom.xml.createDocument = function(e, o) {
    ...
    if (void 0 !== e.selectNodes) return void 0 !== (t = goog.dom.getOwnerDocument(e)).setProperty && t.setProperty("SelectionLanguage", "XPath"), e.selectNodes(o);
    if (document.implementation.hasFeature("XPath", "3.0")) {
        for (var t, r = (t = goog.dom.getOwnerDocument(e)).createNSResolver(t.documentElement), g = t.evaluate(o, e, r, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null), n = [], i = g.snapshotLength, a = 0; a < i; a++) n.push(g.snapshotItem(a));
        return n
    }
    return []
    ...
    if (e) {
        ...
        try {
            e.setProperty("ProhibitDTD", !0), e.setProperty("MaxXMLSize", goog.dom.xml.MAX_XML_SIZE_KB), e.setProperty("MaxElementDepth", goog.dom.xml.MAX_ELEMENT_DEPTH)
        } catch (e) {}
    }
    return e
}, goog.provide("dymo.xml"), goog.provide("dymo.xml.XPathExpression"), goog.require("goog.dom.xml"), dymo.xml.parse = function(e) {
    ...
    dymo.xml.removeAllChildren(e), e.appendChild(e.ownerDocument.createTextNode(o))
}, dymo.xml.removeAllChildren = function(e) {
    for (; e.firstChild;) e.removeChild(e.firstChild)
}, goog.provide("dymo.label.framework.LabelSetBuilder"), goog.provide("dymo.label.framework.ILabelSetRecord"), goog.provide("dymo.label.framework.LabelSetRecord"), dymo.label.framework.ILabelSetRecord = function() {}, dymo.label.framework.ILabelSetRecord.prototype.setTextMarkup = function(e, o) {}, dymo.label.framework.ILabelSetRecord.prototype.setText = function(e, o) {}, dymo.label.framework.ILabelSetRecord.prototype.setBase64Image = function(e, o) {}, dymo.label.framework.LabelSetBuilder = function() {
    ...
    for (var o = dymo.xml.parse("<LabelSet/>"), t = o.documentElement, r = 0; r < e.length; r++) {
        ...
        for (var i in g) {
            ...
            if ("function" != typeof a) {
                ...
                if (s.setAttribute("Name", i), 0 == a.indexOf(TextMarkupTag)) {
...
}, dymo.label.framework.LabelSetRecord = function() {}, dymo.label.framework.LabelSetRecord.prototype.setTextMarkup = function(e, o) {
    return 0 != (o = o.toString()).indexOf(TextMarkupTag) && (o = TextMarkupTag + o + TextMarkupClosedTag), this[e] = o, this
}, goog.exportProperty(dymo.label.framework.LabelSetRecord.prototype, "setTextMarkup", dymo.label.framework.LabelSetRecord.prototype.setTextMarkup), dymo.label.framework.LabelSetRecord.prototype.setText = function(e, o) {
    return this[e] = o, this
}, goog.exportProperty(dymo.label.framework.LabelSetRecord.prototype, "setText", dymo.label.framework.LabelSetRecord.prototype.setText), dymo.label.framework.LabelSetRecord.prototype.setBase64Image = function(e, o) {
    return this[e] = o, this
}, goog.exportProperty(dymo.label.framework.LabelSetRecord.prototype, "setBase64Image", dymo.label.framework.LabelSetRecord.prototype.setBase64Image), goog.provide("dymo.label.framework.ILabel"), goog.provide("dymo.label.framework.Label"), goog.require("goog.array"), goog.require("goog.dom.DomHelper"), dymo.label.framework.ILabel = function() {}, dymo.label.framework.ILabel.prototype.getLabelXml = function() {}, dymo.label.framework.ILabel.prototype.render = function(e, o) {}, dymo.label.framework.ILabel.prototype.renderAsync = function(e, o) {}, dymo.label.framework.ILabel.prototype.print = function(e, o, t) {}, dymo.label.framework.ILabel.prototype.printAsync = function(e, o, t) {}, dymo.label.framework.ILabel.prototype.print2 = function(e, o, t) {}, dymo.label.framework.ILabel.prototype.print2Async = function(e, o, t) {}, dymo.label.framework.ILabel.prototype.printAndPollStatus = function(e, o, t, r, g) {}, dymo.label.framework.ILabel.prototype.printAndPollStatusAsync = function(e, o, t, r, g) {}, dymo.label.framework.ILabel.prototype.getObjectNames = function() {}, dymo.label.framework.ILabel.prototype.getAddressObjectCount = function() {}, dymo.label.framework.ILabel.prototype.getAddressBarcodePosition = function(e) {}, dymo.label.framework.ILabel.prototype.setAddressBarcodePosition = function(e, o) {}, dymo.label.framework.ILabel.prototype.getAddressText = function(e) {}, dymo.label.framework.ILabel.prototype.setAddressText = function(e, o) {}, dymo.label.framework.ILabel.prototype.isDCDLabel = function() {}, dymo.label.framework.ILabel.prototype.isDLSLabel = function() {}, dymo.label.framework.ILabel.prototype.isValidLabel = function() {}, dymo.label.framework.ILabel.prototype.getObjectText = function(e) {}, dymo.label.framework.ILabel.prototype.setObjectText = function(e, o) {}, dymo.label.framework.ILabel.prototype.setLabelLength = function(e) {}, dymo.label.framework.Label = function(e) {
    this._doc = dymo.xml.parse(e)
}, dymo.label.framework.Label.prototype.getLabelXml = function() {
    return dymo.xml.serialize(this._doc)
}, goog.exportProperty(dymo.label.framework.Label.prototype, "getLabelXml", dymo.label.framework.Label.prototype.getLabelXml), dymo.label.framework.Label.prototype.render = function(e, o) {
    return dymo.label.framework.renderLabel(this.getLabelXml(), e, o)
}, goog.exportProperty(dymo.label.framework.Label.prototype, "render", dymo.label.framework.Label.prototype.render), dymo.label.framework.Label.prototype.renderAsync = function(e, o) {
    return dymo.label.framework.renderLabelAsync(this.getLabelXml(), e, o)
}, goog.exportProperty(dymo.label.framework.Label.prototype, "renderAsync", dymo.label.framework.Label.prototype.renderAsync), dymo.label.framework.Label.prototype.print = function(e, o, t) {
    dymo.label.framework.printLabel(e, o, this.getLabelXml(), t)
}, goog.exportProperty(dymo.label.framework.Label.prototype, "print", dymo.label.framework.Label.prototype.print), dymo.label.framework.Label.prototype.printAsync = function(e, o, t) {
    return dymo.label.framework.printLabelAsync(e, o, this.getLabelXml(), t)
}, goog.exportProperty(dymo.label.framework.Label.prototype, "printAsync", dymo.label.framework.Label.prototype.printAsync), dymo.label.framework.Label.prototype.print2 = function(e, o, t) {
    return dymo.label.framework.printLabel2(e, o, this.getLabelXml(), t)
}, goog.exportProperty(dymo.label.framework.Label.prototype, "print2", dymo.label.framework.Label.prototype.print2), dymo.label.framework.Label.prototype.print2Async = function(e, o, t) {
    return dymo.label.framework.printLabel2Async(e, o, this.getLabelXml(), t)
}, goog.exportProperty(dymo.label.framework.Label.prototype, "print2Async", dymo.label.framework.Label.prototype.print2Async), dymo.label.framework.Label.prototype.printAndPollStatus = function(e, o, t, r, g) {
    return dymo.label.framework.printLabelAndPollStatus(e, o, this.getLabelXml(), t, r, g)
}, goog.exportProperty(dymo.label.framework.Label.prototype, "printAndPollStatus", dymo.label.framework.Label.prototype.printAndPollStatus), dymo.label.framework.Label.prototype.printAndPollStatusAsync = function(e, o, t, r, g) {
...
dymo.label.framework.Label.prototype._getObjectElements = function(e) {
    ...
    for (var e = this._getObjectElements(), o = new Array, t = 0; t < e.length; t++) o.push(dymo.xml.getElementText(dymo.xml.getElement(e[t], "Name")));
    return o
}, goog.exportProperty(dymo.label.framework.Label.prototype, "getObjectNames", dymo.label.framework.Label.prototype.getObjectNames), dymo.label.framework.Label.prototype._getAddressObjectElements = function() {
...
}, goog.exportProperty(dymo.label.framework.Label.prototype, "getAddressObjectCount", dymo.label.framework.Label.prototype.getAddressObjectCount), dymo.label.framework.Label.prototype._getAddressObjectElementByIndex = function(e) {
...
}, goog.exportProperty(dymo.label.framework.Label.prototype, "getAddressBarcodePosition", dymo.label.framework.Label.prototype.getAddressBarcodePosition), dymo.label.framework.Label.prototype._verifyAddressBarcodePosition = function(e) {
    if (e != dymo.label.framework.AddressBarcodePosition.AboveAddress && e != dymo.label.framework.AddressBarcodePosition.BelowAddress && e != dymo.label.framework.AddressBarcodePosition.Suppress) throw new Error("verifyAddressBarcodePosition(): barcode position '" + e + "' is invalid value")
}, dymo.label.framework.Label.prototype.setAddressBarcodePosition = function(e, o) {
    return this.isDCDLabel() || (this._verifyAddressBarcodePosition(o), dymo.xml.setElementText(dymo.xml.getElement(this._getAddressObjectElementByIndex(e), "BarcodePosition"), o)), this
}, goog.exportProperty(dymo.label.framework.Label.prototype, "setAddressBarcodePosition", dymo.label.framework.Label.prototype.setAddressBarcodePosition), dymo.label.framework.Label.prototype.getAddressText = function(e) {
    return this._getAddressObjectText(this._getAddressObjectElementByIndex(e))
}, goog.exportProperty(dymo.label.framework.Label.prototype, "getAddressText", dymo.label.framework.Label.prototype.getAddressText), dymo.label.framework.Label.prototype.setAddressText = function(e, o) {
    return this._setAddressObjectText(this._getAddressObjectElementByIndex(e), o)
}, goog.exportProperty(dymo.label.framework.Label.prototype, "setAddressText", dymo.label.framework.Label.prototype.setAddressText), dymo.label.framework.Label.prototype._getObjectByNameElement = function(e) {
    for (var o = this._getObjectElements(), t = 0; t < o.length; t++) {
        var r = o[t];
        if (dymo.xml.getElementText(dymo.xml.getElement(r, "Name")) == e) return r
    }
    ...
    var e = !1,
        o = this.getLabelXml();
    return o && (e = -1 !== o.indexOf("</DYMOLabel>")), e
}, goog.exportProperty(dymo.label.framework.Label.prototype, "isDCDLabel", dymo.label.framework.Label.prototype.isDCDLabel), dymo.label.framework.Label.prototype.isDLSLabel = function() {
    var e = !1,
        o = this.getLabelXml();
    return o && (e = -1 !== o.indexOf("</DieCutLabel>") || -1 !== o.indexOf("</ContinuousLabel>")), e
}, goog.exportProperty(dymo.label.framework.Label.prototype, "isDLSLabel", dymo.label.framework.Label.prototype.isDLSLabel), dymo.label.framework.Label.prototype.isValidLabel = function() {
    return this.isDCDLabel() || this.isDLSLabel()
}, goog.exportProperty(dymo.label.framework.Label.prototype, "isValidLabel", dymo.label.framework.Label.prototype.isValidLabel), dymo.label.framework.Label.prototype._getAddressObjectText = function(e) {
    var o = "";
    if (this.isDCDLabel())
    ...
    return r && (o = dymo.xml.getElementText(r)), o
    ...
    } else o = dymo.xml.getElementText(dymo.xml.getElement(e, "PreText"));
    return o
    ...
    return t
}, goog.exportProperty(dymo.label.framework.Label.prototype, "getObjectText", dymo.label.framework.Label.prototype.getObjectText), dymo.label.framework.Label.prototype._getStyledTextLineAttributes = function(e) {
    for (var o = new Array, t = dymo.xml.getElements(e, "Element"), r = !0, g = 0; g < t.length; g++) {
        ...
        if (i && i.length) {
            ...
            if (1 != s || r) {
                var l = 0;
                r || (l = 1);
                for (var u = dymo.xml.getElement(n, "Attributes"); l < s - 1; l++) o.push(u);
                r = !(0 < a[s - 1].length) || (o.push(u), !1)
            }
        }
    }
    return o
    ...
    if (this.isDCDLabel()) {
        ...
        var i, a = dymo.xml.getElement(e, "StyledText"),
            s = this._getStyledTextLineAttributes(a),
            l = dymo.xml.getElement(e, "LineFonts"),
            u = [];
        l && (u = dymo.xml.getElements(l, "Font")), 0 == u.length && (i = dymo.xml.parse('<Font Family="Arial" Size="12" Bold="False" Italic="False" Underline="False" Strikeout="False" />').documentElement);
        ...
        for (var d = o.split("\n"), m = 0; m < d.length; m++) {
            ...
            E.appendChild(f.cloneNode(!0)), E.appendChild(h.cloneNode(!0)), _.appendChild(y), _.appendChild(E), a.appendChild(_)
        }
    }
    return this
    ...
    var t = this.isDCDLabel() ? "Data" : "Text",
        r = dymo.xml.getElement(e, t);
    return r && dymo.xml.setElementText(r, o), this
    ...
    if (this.isDCDLabel()) {
        ...
        if (r) dymo.xml.setElementText(r, o);
            ...
            if (!g) throw new Error("setObjectText(): <ImageLocation> is expected but not found: " + dymo.xml.serialize(r));
            r = g.ownerDocument.createElement("Image"), dymo.xml.setElementText(r, o), e.replaceChild(r, g)
        }
    }
    return this
    ...
    } else dymo.xml.setElementText(dymo.xml.getElement(e, "PreText"), o);
    return this
    ...
    return this
}, goog.exportProperty(dymo.label.framework.Label.prototype, "setObjectText", dymo.label.framework.Label.prototype.setObjectText), dymo.label.framework.Label.prototype.setLabelLength = function(e) {
    var o = this._doc.documentElement;
    if ("ContinuousLabel" != o.nodeName) throw new Error("Cannot set length on non-continuous label.");
    var t = 0 == e ? "Auto" : "Fixed",
        r = 0 == e ? 7200 : e;
    dymo.xml.setElementText(dymo.xml.getElement(o, "LengthMode"), t), dymo.xml.setElementText(dymo.xml.getElement(o, "LabelLength"), r);
    var g = dymo.xml.getElement(o, "RootCell");
    return dymo.xml.setElementText(dymo.xml.getElement(g, "Length"), r), dymo.xml.setElementText(dymo.xml.getElement(g, "LengthMode"), t), this
}, goog.exportProperty(dymo.label.framework.Label.prototype, "setLabelLength", dymo.label.framework.Label.prototype.setLabelLength), dymo.label.framework.Label.prototype.toString = function() {
    return this.getLabelXml()
}, goog.provide("goog.async.Deferred"), goog.provide("goog.async.Deferred.AlreadyCalledError"), goog.provide("goog.async.Deferred.CanceledError"), goog.require("goog.Promise"), goog.require("goog.Thenable"), goog.require("goog.array"), goog.require("goog.asserts"), goog.require("goog.debug.Error"), goog.async.Deferred = function(e, o) {
    if (this.sequence_ = [], this.onCancelFunction_ = e, this.defaultScope_ = o || null, this.fired_ = !1, this.hadError_ = !1, this.result_ = void 0, this.blocked_ = !1, this.blocking_ = !1, this.silentlyCanceled_ = !1, this.unhandledErrorId_ = 0, this.parent_ = null, this.branches_ = 0, goog.async.Deferred.LONG_STACK_TRACES && (this.constructorStack_ = null, Error.captureStackTrace)) {
        var t = {
            stack: ""
        };
        Error.captureStackTrace(t, goog.async.Deferred), "string" == typeof t.stack && (this.constructorStack_ = t.stack.replace(/^[^\n]*\n/, ""))
    }
}, goog.define("goog.async.Deferred.STRICT_ERRORS", !1), goog.define("goog.async.Deferred.LONG_STACK_TRACES", !1), goog.async.Deferred.prototype.cancel = function(e) {
    if (this.hasFired()) this.result_ instanceof goog.async.Deferred && this.result_.cancel();
    else {
        if (this.parent_) {
            var o = this.parent_;
            delete this.parent_, e ? o.cancel(e) : o.branchCancel_()
        }
    ...
    this.check_(), this.assertNotDeferred_(e), this.makeStackTraceLong_(e), this.updateResult_(!1, e)
    ...
    return goog.asserts.assert(!this.blocking_, "Blocking Deferreds can not be re-used"), this.sequence_.push([e, o, t]), this.hasFired() && this.fire_(), this
...
}, goog.Thenable.addImplementation(goog.async.Deferred), goog.async.Deferred.prototype.chainDeferred = function(e) {
    ...
    this.unhandledErrorId_ && this.hasFired() && this.hasErrback_() && (goog.async.Deferred.unscheduleError_(this.unhandledErrorId_), this.unhandledErrorId_ = 0), this.parent_ && (this.parent_.branches_--, delete this.parent_);
    for (var o = this.result_, t = !1, e = !1; this.sequence_.length && !this.blocked_;) {
        ...
        if (a) try {
            ...
            goog.isDef(s) && (this.hadError_ = this.hadError_ && (s == o || this.isError(s)), this.result_ = o = s), (goog.Thenable.isImplementedBy(o) || "function" == typeof goog.global.Promise && o instanceof goog.global.Promise) && (e = !0, this.blocked_ = !0)
        } catch (e) {
            o = e, this.hadError_ = !0, this.makeStackTraceLong_(o), this.hasErrback_() || (t = !0)
        }
    }
    if (this.result_ = o, e) {
        var l = goog.bind(this.continue_, this, !0),
            u = goog.bind(this.continue_, this, !1);
        o instanceof goog.async.Deferred ? (o.addCallbacks(l, u), o.blocking_ = !0) : o.then(l, u)
    } else !goog.async.Deferred.STRICT_ERRORS || !this.isError(o) || o instanceof goog.async.Deferred.CanceledError || (t = this.hadError_ = !0);
    ...
    var o = new goog.async.Deferred;
    return o.callback(), o.addCallback(function() {
        return e
    }), o
...
}, goog.inherits(goog.async.Deferred.AlreadyCalledError, goog.debug.Error), goog.async.Deferred.AlreadyCalledError.prototype.message = "Deferred has already fired", goog.async.Deferred.AlreadyCalledError.prototype.name = "AlreadyCalledError", goog.async.Deferred.CanceledError = function(e) {
    goog.debug.Error.call(this), this.deferred = e
}, goog.inherits(goog.async.Deferred.CanceledError, goog.debug.Error), goog.async.Deferred.CanceledError.prototype.message = "Deferred was canceled", goog.async.Deferred.CanceledError.prototype.name = "CanceledError", goog.async.Deferred.Error_ = function(e) {
    this.id_ = goog.global.setTimeout(goog.bind(this.throwError, this), 0), this.error_ = e
}, goog.async.Deferred.Error_.prototype.throwError = function() {
    throw goog.asserts.assert(goog.async.Deferred.errorMap_[this.id_], "Cannot throw an error that is not scheduled."), delete goog.async.Deferred.errorMap_[this.id_], this.error_
}, goog.async.Deferred.Error_.prototype.resetTimer = function() {
    goog.global.clearTimeout(this.id_)
}, goog.async.Deferred.errorMap_ = {}, goog.async.Deferred.scheduleError_ = function(e) {
    ...
    return 0 < s && (a = window.setTimeout(function() {
        goog.net.jsloader.cleanup_(g, !0), i.errback(new goog.net.jsloader.Error(goog.net.jsloader.ErrorCode.TIMEOUT, "Timeout reached for loading script " + e))
    }, s), n.timeout_ = a), g.onload = g.onreadystatechange = function() {
        if (!g.readyState || "loaded" == g.readyState || "complete" == g.readyState) {
            var e = t.cleanupWhenDone || !1;
            goog.net.jsloader.cleanup_(g, e, a), i.callback(null)
        }
    }, g.onerror = function() {
        goog.net.jsloader.cleanup_(g, !0, a), i.errback(new goog.net.jsloader.Error(goog.net.jsloader.ErrorCode.LOAD_ERROR, "Error while loading script " + e))
    }, goog.dom.setProperties(g, {
        type: "text/javascript",
        charset: "UTF-8",
        src: e
    }), goog.net.jsloader.getScriptParentElement_(r).appendChild(g), i
    ...
    if (goog.isDef(r[t])) return goog.async.Deferred.fail(new goog.net.jsloader.Error(goog.net.jsloader.ErrorCode.VERIFY_OBJECT_ALREADY_EXISTS, "Verification object " + t + " already defined."));
    var g = goog.net.jsloader.load(o, e),
        n = new goog.async.Deferred(goog.bind(g.cancel, g));
    return g.addCallback(function() {
        var e = r[t];
        goog.isDef(e) ? (n.callback(e), delete r[t]) : n.errback(new goog.net.jsloader.Error(goog.net.jsloader.ErrorCode.VERIFY_ERROR, "Script " + o + " loaded, but verification object " + t + " was not defined."))
    }), g.addErrback(function(e) {
        goog.isDef(r[t]) && delete r[t], n.errback(e)
    }), n
    ...
    goog.isDefAndNotNull(t) && goog.global.clearTimeout(t), e.onload = goog.nullFunction, e.onerror = goog.nullFunction, e.onreadystatechange = goog.nullFunction, o && window.setTimeout(function() {
    ...
    o && (t += ": " + o), goog.net.jsloader.Error.base(this, "constructor", t), this.code = e
}, goog.inherits(goog.net.jsloader.Error, goog.debug.Error), goog.provide("goog.net.Jsonp"), goog.require("goog.Uri"), goog.require("goog.net.jsloader"), goog.net.Jsonp = function(e, o) {
    this.uri_ = new goog.Uri(e), this.callbackParamName_ = o || "callback", this.timeout_ = 5e3
}, goog.net.Jsonp.CALLBACKS = "_callbacks_", goog.net.Jsonp.scriptCounter_ = 0, goog.net.Jsonp.prototype.setRequestTimeout = function(e) {
    this.timeout_ = e
    ...
    if (g && goog.net.Jsonp.addPayloadToUri_(g, i), o) {
        var a = goog.net.Jsonp.newReplyHandler_(n, o);
        goog.global[goog.net.Jsonp.CALLBACKS][n] = a, i.setParameterValues(this.callbackParamName_, goog.net.Jsonp.CALLBACKS + "." + n)
    }
    ...
    e && (e.deferred_ && e.deferred_.cancel(), e.id_ && goog.net.Jsonp.cleanup_(e.id_, !1))
    ...
    for (var t in e) e.hasOwnProperty && !e.hasOwnProperty(t) || o.setParameterValues(t, e[t]);
    return o
}, goog.provide("goog.dom.InputType"), goog.dom.InputType = {
    BUTTON: "button",
    CHECKBOX: "checkbox",
    COLOR: "color",
    DATE: "date",
    ...
    URL: "url",
    WEEK: "week"
}, goog.provide("goog.net.IframeIo"), goog.provide("goog.net.IframeIo.IncrementalDataEvent"), goog.require("goog.Timer"), goog.require("goog.Uri"), goog.require("goog.asserts"), goog.require("goog.debug"), goog.require("goog.dom"), goog.require("goog.dom.InputType"), goog.require("goog.dom.TagName"), goog.require("goog.dom.safe"), goog.require("goog.events"), goog.require("goog.events.Event"), goog.require("goog.events.EventTarget"), goog.require("goog.events.EventType"), goog.require("goog.html.uncheckedconversions"), goog.require("goog.json"), goog.require("goog.log"), goog.require("goog.log.Level"), goog.require("goog.net.ErrorCode"), goog.require("goog.net.EventType"), goog.require("goog.reflect"), goog.require("goog.string"), goog.require("goog.string.Const"), goog.require("goog.structs"), goog.require("goog.userAgent"), goog.net.IframeIo = function() {
    goog.net.IframeIo.base(this, "constructor"), this.name_ = goog.net.IframeIo.getNextName_(), this.iframesForDisposal_ = [], goog.net.IframeIo.instances_[this.name_] = this
}, goog.inherits(goog.net.IframeIo, goog.events.EventTarget), goog.net.IframeIo.instances_ = {}, goog.net.IframeIo.FRAME_NAME_PREFIX = "closure_frame", goog.net.IframeIo.INNER_FRAME_SUFFIX = "_inner", goog.net.IframeIo.IFRAME_DISPOSE_DELAY_MS = 2e3, goog.net.IframeIo.counter_ = 0, goog.net.IframeIo.form_, goog.net.IframeIo.send = function(e, o, t, r, g) {
    var n = new goog.net.IframeIo;
    goog.events.listen(n, goog.net.EventType.READY, n.dispose, !1, n), o && goog.events.listen(n, goog.net.EventType.COMPLETE, o), n.send(e, t, r, g)
    ...
    if (g && t == g.iframeName_) g.handleIncrementalData_(o);
    else {
    ...
    if (!goog.net.IframeIo.form_) {
        goog.net.IframeIo.form_ = goog.dom.createDom(goog.dom.TagName.FORM), goog.net.IframeIo.form_.acceptCharset = "utf-8";
        var e = goog.net.IframeIo.form_.style;
        e.position = "absolute", e.visibility = "hidden", e.top = e.left = "-10px", e.width = e.height = "10px", e.overflow = "hidden", goog.dom.getDocument().body.appendChild(goog.net.IframeIo.form_)
    }
...
}, goog.net.IframeIo.prototype.logger_ = goog.log.getLogger("goog.net.IframeIo"), goog.net.IframeIo.prototype.form_ = null, goog.net.IframeIo.prototype.iframe_ = null, goog.net.IframeIo.prototype.iframeName_ = null, goog.net.IframeIo.prototype.nextIframeId_ = 0, goog.net.IframeIo.prototype.active_ = !1, goog.net.IframeIo.prototype.complete_ = !1, goog.net.IframeIo.prototype.success_ = !1, goog.net.IframeIo.prototype.lastUri_ = null, goog.net.IframeIo.prototype.lastContent_ = null, goog.net.IframeIo.prototype.lastErrorCode_ = goog.net.ErrorCode.NO_ERROR, goog.net.IframeIo.prototype.firefoxSilentErrorTimeout_ = null, goog.net.IframeIo.prototype.iframeDisposalTimer_ = null, goog.net.IframeIo.prototype.errorHandled_, goog.net.IframeIo.prototype.ignoreResponse_ = !1, goog.net.IframeIo.prototype.errorChecker_, goog.net.IframeIo.prototype.lastCustomError_, goog.net.IframeIo.prototype.lastContentHtml_, goog.net.IframeIo.prototype.send = function(e, o, t, r) {
    if (this.active_) throw Error("[goog.net.IframeIo] Unable to send, already active.");
    var g = new goog.Uri(e);
    this.lastUri_ = g;
    var n = o ? o.toUpperCase() : "GET";
    t && g.makeUnique(), goog.log.info(this.logger_, "Sending iframe request: " + g + " [" + n + "]"), this.form_ = goog.net.IframeIo.getForm_(), "GET" == n && goog.net.IframeIo.addFormInputs_(this.form_, g.getQueryData()), r && goog.net.IframeIo.addFormInputs_(this.form_, r), this.form_.action = g.toString(), this.form_.method = n, this.sendFormInternal_(), this.clearForm_()
}, goog.net.IframeIo.prototype.sendFromForm = function(e, o, t) {
    if (this.active_) throw Error("[goog.net.IframeIo] Unable to send, already active.");
    var r = new goog.Uri(o || e.action);
    t && r.makeUnique(), goog.log.info(this.logger_, "Sending iframe request from form: " + r), this.lastUri_ = r, this.form_ = e, this.form_.action = r.toString(), this.sendFormInternal_()
}, goog.net.IframeIo.prototype.abort = function(e) {
    if (this.active_) {
        goog.log.info(this.logger_, "Request aborted");
        var o = this.getRequestIframe();
        goog.asserts.assert(o), goog.events.removeAll(o), this.complete_ = !1, this.active_ = !1, this.success_ = !1, this.lastErrorCode_ = e || goog.net.ErrorCode.ABORT, this.dispatchEvent(goog.net.EventType.ABORT), this.makeReady_()
    }
}, goog.net.IframeIo.prototype.disposeInternal = function() {
    goog.log.fine(this.logger_, "Disposing iframeIo instance"), this.active_ && (goog.log.fine(this.logger_, "Aborting active request"), this.abort()), goog.net.IframeIo.superClass_.disposeInternal.call(this), this.iframe_ && this.scheduleIframeDisposal_(), this.disposeForm_(), delete this.errorChecker_, this.form_ = null, this.lastCustomError_ = this.lastContent_ = this.lastContentHtml_ = null, this.lastUri_ = null, this.lastErrorCode_ = goog.net.ErrorCode.NO_ERROR, delete goog.net.IframeIo.instances_[this.name_]
    ...
    if (this.active_ = !0, this.complete_ = !1, this.lastErrorCode_ = goog.net.ErrorCode.NO_ERROR, this.createIframe_(), goog.net.IframeIo.useIeReadyStateCodePath_()) {
        this.form_.target = this.iframeName_ || "", this.appendIframe_(), this.ignoreResponse_ || goog.events.listen(this.iframe_, goog.events.EventType.READYSTATECHANGE, this.onIeReadyStateChange_, !1, this);
        try {
            this.errorHandled_ = !1, this.form_.submit()
        } catch (e) {
            this.ignoreResponse_ || goog.events.unlisten(this.iframe_, goog.events.EventType.READYSTATECHANGE, this.onIeReadyStateChange_, !1, this), this.handleError_(goog.net.ErrorCode.ACCESS_DENIED)
        }
    } else {
        goog.log.fine(this.logger_, "Setting up iframes and cloning form"), this.appendIframe_();
        var e, o = this.iframeName_ + goog.net.IframeIo.INNER_FRAME_SUFFIX,
            t = goog.dom.getFrameContentDocument(this.iframe_);
        e = document.baseURI ? goog.net.IframeIo.createIframeHtmlWithBaseUri_(o) : goog.net.IframeIo.createIframeHtml_(o), goog.userAgent.OPERA ? goog.dom.safe.setInnerHtml(t.documentElement, e) : goog.dom.safe.documentWrite(t, e), this.ignoreResponse_ || goog.events.listen(t.getElementById(o), goog.events.EventType.LOAD, this.onIframeLoaded_, !1, this);
        for (var r = this.form_.getElementsByTagName(goog.dom.TagName.TEXTAREA), g = 0, n = r.length; g < n; g++) {
            var i = r[g].value;
            goog.dom.getRawTextContent(r[g]) != i && (goog.dom.setTextContent(r[g], i), r[g].value = i)
        }
        var a = t.importNode(this.form_, !0);
        a.target = o, a.action = this.form_.action, t.body.appendChild(a);
        ...
        for (g = 0, n = s.length; g < n; g++)
            for (var u = s[g].getElementsByTagName(goog.dom.TagName.OPTION), c = l[g].getElementsByTagName(goog.dom.TagName.OPTION), d = 0, m = u.length; d < m; d++) c[d].selected = u[d].selected;
        var p = this.form_.getElementsByTagName(goog.dom.TagName.INPUT),
            f = a.getElementsByTagName(goog.dom.TagName.INPUT);
        for (g = 0, n = p.length; g < n; g++)
            if (p[g].type == goog.dom.InputType.FILE && p[g].value != f[g].value) {
                goog.log.fine(this.logger_, "File input value not cloned properly.  Will submit using original form."), this.form_.target = o, a = this.form_;
                break
            } goog.log.fine(this.logger_, "Submitting form");
        try {
            this.errorHandled_ = !1, a.submit(), t.close(), goog.userAgent.GECKO && (this.firefoxSilentErrorTimeout_ = goog.Timer.callOnce(this.testForFirefoxSilentError_, 250, this))
        } catch (e) {
            goog.log.error(this.logger_, "Error when submitting form: " + goog.debug.exposeException(e)), this.ignoreResponse_ || goog.events.unlisten(t.getElementById(o), goog.events.EventType.LOAD, this.onIframeLoaded_, !1, this), t.close(), this.handleError_(goog.net.ErrorCode.FILE_NOT_FOUND)
        }
    }
    ...
    if ("complete" == this.iframe_.readyState) {
        ...
        try {
            if (o = goog.dom.getFrameContentDocument(this.iframe_), goog.userAgent.IE && "about:blank" == o.location && !navigator.onLine) return void this.handleError_(goog.net.ErrorCode.OFFLINE)
        } catch (e) {
    ...
    var o, t;
    goog.log.fine(this.logger_, "Iframe loaded"), this.complete_ = !0, this.active_ = !1;
    try {
        var r = e.body;
        this.lastContent_ = r.textContent || r.innerText, this.lastContentHtml_ = r.innerHTML
    } catch (e) {
        o = goog.net.ErrorCode.ACCESS_DENIED
    }
    o || "function" != typeof this.errorChecker_ || (t = this.errorChecker_(e)) && (o = goog.net.ErrorCode.CUSTOM_ERROR), goog.log.log(this.logger_, goog.log.Level.FINER, "Last content: " + this.lastContent_), goog.log.log(this.logger_, goog.log.Level.FINER, "Last uri: " + this.lastUri_), o ? (goog.log.fine(this.logger_, "Load event occurred but failed"), this.handleError_(o, t)) : (goog.log.fine(this.logger_, "Load succeeded"), this.success_ = !0, this.lastErrorCode_ = goog.net.ErrorCode.NO_ERROR, this.dispatchEvent(goog.net.EventType.COMPLETE), this.dispatchEvent(goog.net.EventType.SUCCESS), this.makeReady_())
}, goog.net.IframeIo.prototype.handleError_ = function(e, o) {
    this.errorHandled_ || (this.success_ = !1, this.active_ = !1, this.complete_ = !0, (this.lastErrorCode_ = e) == goog.net.ErrorCode.CUSTOM_ERROR && (goog.asserts.assert(goog.isDef(o)), this.lastCustomError_ = o), this.dispatchEvent(goog.net.EventType.COMPLETE), this.dispatchEvent(goog.net.EventType.ERROR), this.makeReady_(), this.errorHandled_ = !0)
    ...
    goog.log.info(this.logger_, "Ready for new requests"), this.scheduleIframeDisposal_(), this.disposeForm_(), this.dispatchEvent(goog.net.EventType.READY)
}, goog.net.IframeIo.prototype.createIframe_ = function() {
    goog.log.fine(this.logger_, "Creating iframe"), this.iframeName_ = this.name_ + "_" + (this.nextIframeId_++).toString(36);
    var e = {
        name: this.iframeName_,
        id: this.iframeName_
    };
    goog.userAgent.IE && goog.userAgent.VERSION < 7 && (e.src = 'javascript:""'), this.iframe_ = goog.dom.getDomHelper(this.form_).createDom(goog.dom.TagName.IFRAME, e);
    var o = this.iframe_.style;
    o.visibility = "hidden", o.width = o.height = "10px", o.display = "none", goog.userAgent.WEBKIT ? o.marginTop = o.marginLeft = "-10px" : (o.position = "absolute", o.top = o.left = "-10px")
    ...
    if (this.active_) {
        ...
        if (e && !goog.reflect.canAccessProperty(e, "documentUri")) return this.ignoreResponse_ || goog.events.unlisten(this.getRequestIframe(), goog.events.EventType.LOAD, this.onIframeLoaded_, !1, this), void(navigator.onLine ? (goog.log.warning(this.logger_, "Silent Firefox error detected"), this.handleError_(goog.net.ErrorCode.FF_SILENT_ERROR)) : (goog.log.warning(this.logger_, "Firefox is offline so report offline error instead of silent error"), this.handleError_(goog.net.ErrorCode.OFFLINE)));
    ...
    goog.events.Event.call(this, goog.net.EventType.INCREMENTAL_DATA), this.data = e
}, goog.inherits(goog.net.IframeIo.IncrementalDataEvent, goog.events.Event), goog.provide("goog.Delay"), goog.provide("goog.async.Delay"), goog.require("goog.Disposable"), goog.require("goog.Timer"), goog.async.Delay = function(e, o, t) {
    goog.async.Delay.base(this, "constructor"), this.listener_ = e, this.interval_ = o || 0, this.handler_ = t, this.callback_ = goog.bind(this.doAction_, this)
}, goog.inherits(goog.async.Delay, goog.Disposable), goog.Delay = goog.async.Delay, goog.async.Delay.prototype.id_ = 0, goog.async.Delay.prototype.disposeInternal = function() {
    goog.async.Delay.base(this, "disposeInternal"), this.stop(), delete this.listener_, delete this.handler_
}, goog.async.Delay.prototype.start = function(e) {
    this.stop(), this.id_ = goog.Timer.callOnce(this.callback_, goog.isDef(e) ? e : this.interval_)
...
}, goog.provide("dymo.uuid"), dymo.uuid.uuid = function() {
    for (var a = Array, s = new a(16), r = [], g = {}, e = 0; e < 256; e++) r[e] = (e + 256).toString(16).substr(1).toUpperCase(), g[r[e]] = e;
    ...
    function o(e, o, t) {
        var r = 4294967296,
            ...
            n = o && t || 0,
            i = Math.random() * r;
        return g[n++] = 255 & i, g[n++] = 255 & (i >>>= 8), g[n++] = 255 & (i >>>= 8), g[n++] = 255 & (i >>>= 8), i = Math.random() * r, g[n++] = 255 & i, g[n++] = 255 & (i >>>= 8), g[n++] = 15 & (i >>>= 8) | 64, g[n++] = 255 & (i >>>= 8), i = Math.random() * r, g[n++] = 63 & i | 128, g[n++] = 255 & (i >>>= 8), g[n++] = 255 & (i >>>= 8), g[n++] = 255 & (i >>>= 8), i = Math.random() * r, g[n++] = 255 & i, g[n++] = 255 & (i >>>= 8), g[n++] = 255 & (i >>>= 8), g[n++] = 255 & (i >>>= 8), void 0 === e ? l(g) : g
    }
    ...
    }, o.unparse = l, o.BufferClass = a, o
}(), goog.require("goog.Uri"), goog.provide("dymo.label.framework.NetworkPrinter"), dymo.label.framework.NetworkPrinterName = function(e, o) {
    ...
    var o = new goog.Uri(e),
        t = o.getPath();
    return 1 < t.length && "/" == t.charAt(0) && (t = t.slice(1)), o.setPath(""), new dymo.label.framework.NetworkPrinterName(o.toString(), t)
...
function _createSafariPlugin() {
    ...
    if (!document.getElementById(e)) {
        ...
        o.type = "application/x-dymolabel", o.id = e, o.width = 1, o.height = 1, o.hidden = !0, document.body.appendChild(o)
    }
    return window[e]
}
...
function _createNsapiPlugin2(e) {
    ...
    if (!document.getElementById(o)) {
        ...
        t.type = "application/x-dymolabel", t.id = o, e ? (t.width = 1, t.height = 1, t.hidden = !0) : (t.width = 0, t.height = 0, t.hidden = !1), document.body.appendChild(t)
    }
...
function _createNsapiPlugin() {
    ...
    return e.getPrinters || (document.body.removeChild(e), e = _createNsapiPlugin2(!1)), e
}
...
function _createMacNsapiPlugin2(e) {
    ...
    if (!document.getElementById(o)) {
        var t = document.createElement("embed");
        t.type = "application/x-npapi-dymolabel", t.id = o, e ? (t.width = 1, t.height = 1, t.hidden = !0) : (t.width = 0, t.height = 0, t.hidden = !1), document.body.appendChild(t), t.getPrinters || (t.width = 1, t.height = 1, t.hidden = !1)
    }
    return document.getElementById(o)
}
...
function _createMacNsapiPlugin() {
    ...
    return e.getPrinters || (document.body.removeChild(e), e = _createMacNsapiPlugin2(!1)), e
}

function _createIePlugin() {
    if (ASSUME_MOBILE) return null;
    var e = new ActiveXObject("DYMOLabelFrameworkIEPlugin.Plugin");
    if ("object" != typeof e) throw new Error("createFramework(): unable to create DYMO.Label.Framework object. Check DYMO Label Framework is installed");
    return e
}
...
dymo.label.framework.PrintJobStatusInfo = function(e, o, t, r) {
    this.printerName = e, this.jobId = o, this.status = t, this.statusMessage = r
}, dymo.label.framework.PrintJobStatusInfo.parse = function(e) {
    var o = {},
        t = e.split(" ");
    return 1 <= t.length && (o.status = parseInt(t[0], 10)), o.statusMessage = t.slice(1).join(" "), o
    ...
    if (e.isWebServicePresent) {
        ...
        if (!g) throw new Error("Cannot establish connection to the web service. Is DYMO Label Framework installed?");
        return o = {
    ...
    if ("ActiveXObject" in window) {
        traceMsg("chooseEnvironment > ActiveXObject"), o = {};
        ...
        o.getPrinters = function() {
            ...
            if (goog.isFunction(n.PrintLabel2)) return n.PrintLabel2(e, o, t, r).toString();
            n.PrintLabel(e, o, t, r)
        ...
        if (!i) throw new Error("DYMO Label Framework is not installed");
        o = {
            getPrinters: function() {
            ...
            printLabel2: function(e, o, t, r) {
                if (goog.isFunction(i.printLabel2)) return i.printLabel2(e, o, t, r).toString();
                i.printLabel(e, o, t, r)
            },
            getJobStatus: function(e, o) {
                var t;
        ...
        var a;
        if (traceMsg("chooseEnvironment > not WIN"), traceMsg("chooseEnvironment > safariPlugin : " + !!(a = _findPlugin("application/x-dymolabel") ? (traceMsg("chooseEnvironment > _createSafariPlugin"), _createSafariPlugin()) : (traceMsg("chooseEnvironment > _createMacNsapiPlugin"), _createMacNsapiPlugin()))), !a) throw new Error("DYMO Label Framework is not installed");
        o = {
            getPrinters: function() {
            ...
            printLabel2: function(e, o, t, r) {
                if (goog.isFunction(a.printLabel2)) return a.printLabel2(t, e, o, r).toString();
                a.printLabel(t, e, o, r)
            },
            getJobStatus: function(e, o) {
                var t;
    ...
    return o.getPrintersAsync = t(o.getPrinters), o.openLabelFileAsync = t(o.openLabelFile), o.printLabelAsync = t(o.printLabel), o.printLabel2Async = t(o.printLabel2), o.renderLabelAsync = t(o.renderLabel), o.loadImageAsPngBase64Async = t(o.loadImageAsPngBase64), o
}, dymo.label.framework.trace = !1, dymo.label.framework.currentFramework = 0;
var createFaultyFramework = function(e) {
    ...
    _createFramework = (Tca = !1, Uca = null, function e(o, t) {
        if (Tca) throw traceMsg("_createFramework > Error service discovery is in progress. "), new Error("DYMO Label Framework service discovery is in progress.");
        return Sca ? (traceMsg("_createFramework > returning existing instance of _framework, has callBack: " + !!o), o && o(Uca), Sca) : this && this.constructor == e ? (Tca = !0, _createFramework.resetFramework = function() {
            Uca = Sca = null, dymo.label.framework.currentFramework = 0
            ...
            try {
                Sca = dymo.label.framework.chooseEnvironment(e), dymo.label.framework.currentFramework = e.isWebServicePresent ? 2 : 1
            } catch (e) {
                if (traceMsg("onEnvironmentChecked > exception e : " + (e.description || e.message || e)), !t) throw e;
                Sca = createFaultyFramework(e), traceMsg("onEnvironmentChecked > fall back to createFaultyFramework")
            } finally {
                Tca = !1
            }
            o && o(Uca)
        }, t), traceMsg("_createFramework > return _framework : " + Sca + (t ? " (async)" : " (sync)")), Sca) : new e(o, t)
    }),
    Sca, Tca, Uca;
dymo.label.framework.init = function(e) {
    _createFramework(e, !0)
}, goog.provide("dymo.label.framework.PrinterInfo"), goog.provide("dymo.label.framework.LabelWriterPrinterInfo"), goog.provide("dymo.label.framework.TapePrinterInfo"), goog.provide("dymo.label.framework.DZPrinterInfo"), dymo.label.framework.PrinterInfo = function(e, o, t, r, g) {
    this.printerType = e, this.name = o, this.modelName = t, this.isConnected = r, this.isLocal = g, this.printerUri = "", this.originalPrinterName = ""
    ...
    dymo.label.framework.PrinterInfo.call(this, "LabelWriterPrinter", e, o, t, r), this.isTwinTurbo = g
}, goog.inherits(dymo.label.framework.LabelWriterPrinterInfo, dymo.label.framework.PrinterInfo), dymo.label.framework.TapePrinterInfo = function(e, o, t, r, g) {
    dymo.label.framework.PrinterInfo.call(this, "TapePrinter", e, o, t, r), this.isAutoCutSupported = g
}, goog.inherits(dymo.label.framework.TapePrinterInfo, dymo.label.framework.PrinterInfo), dymo.label.framework.DZPrinterInfo = function(e, o, t, r, g) {
    dymo.label.framework.PrinterInfo.call(this, "DZPrinter", e, o, t, r), this.isAutoCutSupported = g
}, goog.inherits(dymo.label.framework.DZPrinterInfo, dymo.label.framework.PrinterInfo), goog.require("goog.net.Jsonp"), goog.require("goog.Uri"), goog.require("dymo.label.framework.NetworkPrinter"), goog.require("dymo.label.framework.PrintJobStatusInfo"), goog.require("dymo.label.framework.PrinterInfo"), goog.provide("dymo.label.framework.PrintJob"), dymo.label.framework.PrintJob = function(e, o) {
...
}, goog.exportProperty(dymo.label.framework.PrintJob.prototype, "getPrinterName", dymo.label.framework.PrintJob.prototype.getPrinterName), dymo.label.framework.PrintJob.prototype.getJobId = function() {
    return this._jobId
}, goog.exportProperty(dymo.label.framework.PrintJob.prototype, "getJobId", dymo.label.framework.PrintJob.prototype.getJobId), dymo.label.framework.PrintJob.prototype.getStatus = function(e) {
    if (this._printerInfo.isNetworkPrinter()) this.getStatusForNetworkPrinter(e);
    else {
        var o;
        try {
...
}, goog.exportProperty(dymo.label.framework.PrintJob.prototype, "getStatus", dymo.label.framework.PrintJob.prototype.getStatus), dymo.label.framework.PrintJob.prototype.getStatusForNetworkPrinter = function(t) {
...
}, goog.require("goog.net.Jsonp"), goog.require("goog.net.IframeIo"), goog.require("goog.async.Delay"), goog.require("dymo.uuid"), goog.require("dymo.label.framework.PrintJob"), goog.provide("dymo.label.framework.CheckEnvironmentResult"), dymo.label.framework.VERSION = "3.0.0", dymo.label.framework.CheckEnvironmentResult = function(e) {
    this.isWebServicePresent = e.isWebServicePresent, this.isBrowserSupported = e.isBrowserSupported, this.isFrameworkInstalled = e.isFrameworkInstalled, this.errorDetails = e.errorDetails
}, dymo.label.framework.checkEnvironment = function(e, o) {
    function t() {
        g.isBrowserSupported = !0, g.isFrameworkInstalled = !0, g.isWebServicePresent = !0, e && e(g)
    }
    ...
    function r() {
        ! function() {
            ...
            if (-1 != e.indexOf("Win"))
                if (traceMsg("checkLegacyPlugins > WIN platform "), "ActiveXObject" in window) {
                    traceMsg("checkLegacyPlugins > ActiveXObject"), g.isBrowserSupported = !0;
                    try {
                ...
                } else traceMsg("checkLegacyPlugins > non-IE"), g.isBrowserSupported = !0, _findPlugin("application/x-dymolabel") ? (traceMsg("checkLegacyPlugins > 'application/x-dymolabel'"), g.isFrameworkInstalled = !0) : g.errorDetails = "DYMO Label Framework Plugin is not installed";
            else if (-1 != e.indexOf("Mac")) {
                var o;
                if (traceMsg("checkLegacyPlugins > Mac platform"), g.isBrowserSupported = !0, _findPlugin("application/x-dymolabel")) traceMsg("checkLegacyPlugins > safariPluginFound"), "2.0" <= (o = _createSafariPlugin()).GetAPIVersion() ? g.isFrameworkInstalled = !0 : g.errorDetails = "DYMO Label Safari Plugin is installed but outdated. Install the latest version.";
                else if (_findPlugin("application/x-npapi-dymolabel")) traceMsg("checkLegacyPlugins > 'application/x-npapi-dymolabel'"), (o = _createMacNsapiPlugin()) && o.getPrinters ? g.isFrameworkInstalled = !0 : g.errorDetails = 'DYMO NSAPI plugin is loaded but no callable functions found. If running Safari, then run it in 64-bit mode (MacOS X >= 10.7) or set "Open using Rosetta" option';
                else g.errorDetails = "DYMO Label Plugin is not installed."
            } else g.errorDetails = "The operating system is not supported."
        }(), e && e(g)
    }
    var g = {
    ...
    return dymo.label.framework.currentFramework ? (traceMsg("checkEnvironment > return existing instance of framework"), 2 == dymo.label.framework.currentFramework ? t() : (g.isBrowserSupported = !0, g.isFrameworkInstalled = !0, g.isWebServicePresent = !1, e && e(g))) : o ? asyncFindWebService(t, r) : syncCheckWebService(t, r), g
};
...
function createPrintersCollection() {
    var e = [];
    return e.byIndex = [], Object.defineProperty(e, "byIndex", {
        enumerable: !1,
        value: []
    }), e
}
...
function addPrinterToCollection(e, o) {
    var t = e.name;
    o.push(e), o.byIndex.push(e), t.match(/^\d+$/) && console.error("Printer name consisting of numbers only (" + t + ') will break proper array behavior. Consider using "byIndex" property for accessing elements by index reliably.'), "length" === t && console.error('Using "length" as printer name overrides Array.length property!'), o[t] = e
}
...
function getPrinters(e) {
    ...
    var t, r, g, n, i, a, s, l = dymo.xml.parse(e),
        u = createPrintersCollection(),
        c = dymo.xml.getElement(l, "Printers"),
        d = dymo.xml.getElements(c, "LabelWriterPrinter");
    for (t = 0; t < d.length; t++) {
        r = o(d[t], "Name"), g = o(d[t], "ModelName"), n = "True" == o(d[t], "IsConnected"), i = "True" == o(d[t], "IsLocal"), a = "True" == o(d[t], "IsTwinTurbo"), addPrinterToCollection(new dymo.label.framework.LabelWriterPrinterInfo(r, g, n, i, a), u)
    }
    var m = dymo.xml.getElements(c, "TapePrinter");
    for (t = 0; t < m.length; t++) {
        r = o(m[t], "Name"), g = o(m[t], "ModelName"), n = "True" == o(m[t], "IsConnected"), i = "True" == o(m[t], "IsLocal"), s = "True" == o(m[t], "IsAutoCutSupported"), addPrinterToCollection(new dymo.label.framework.TapePrinterInfo(r, g, n, i, s), u)
    }
    var p = dymo.xml.getElements(c, "DZPrinter");
    for (t = 0; t < p.length; t++) {
        r = o(p[t], "Name"), g = o(p[t], "ModelName"), n = "True" == o(p[t], "IsConnected"), i = "True" == o(p[t], "IsLocal"), s = "True" == o(p[t], "IsAutoCutSupported"), addPrinterToCollection(new dymo.label.framework.DZPrinterInfo(r, g, n, i, s), u)
    }
    return u
}
...
function printLabelToNetworkPrinter(e, o, t, r) {
    var n = dymo.uuid.uuid(),
        ...
        s = function(r, g) {
            var e = 4e3 * r,
                o = "";
            e >= a.length ? r = -1 : o = a.substr(e, 4e3), new goog.net.Jsonp(i, "c").send({
                j: n,
                cid: r,
                pl: o
            }, function(e) {
                ...
                t.setLevel(goog.debug.Logger.Level.INFO), 0 == o ? -1 != r ? s(++r, 0) : t.info("Finished sending job payload for " + n) : -5 == o ? g < 10 ? s(++e.lastAckChunkId, ++g) : t.warning('Unable to send print job data for "' + n + '": STATUS_INVALID_CHUNK_ID: Max retry count reached') : g < 10 ? s(r, ++g) : t.warning('Unable to send print job data for "' + n + '": Max retry count reached')
            }, function() {
                var e = new goog.debug.Logger("dymo.label.framework");
                e.setLevel(goog.debug.Logger.Level.INFO), g < 10 ? s(r, ++g) : e.warning('Unable to send print job data for "' + n + '": error: Max retry count reached')
            })
        };
    return s(0, 0), new dymo.label.framework.PrintJob(e, n)
}

function createRenderLabelRequest(e, o, t, r) {
    var g = {};
    return g.requestId = e, g.imageData = r, g.statusId = o, g.statusMessage = t, g
}
NetworkPrinterInfo.prototype.getPrinters = function() {
    ...
    for (var r = 0; r < e.length; ++r) {
        var g = e[r],
            n = g.name;
        g.name = n + " @ " + t, g.printerUri = this.printerUri, g.location = t, g.originalPrinterName = n, g.printerUri = g.printerUri, g.location = g.location, g.localName = g.originalPrinterName
    }
    return e
    ...
    return o.setLevel(goog.debug.Logger.Level.INFO), o.info(e), new dymo.label.framework.Label(e)
}, dymo.label.framework.printLabel = function(e, o, t, r) {
    if (o = o || "", "string" != typeof(r = r || "") && (r = r.toString()), void 0 === t) throw new Error("printLabel(): labelXml parameter should be specified");
    "string" != typeof t && (t = t.toString());
    var g = dymo.label.framework.getPrinters()[e];
    if (!goog.isDefAndNotNull(g)) throw new Error("printLabel(): unknown printer '" + e + "'");
    ...
    if (r = r || "", "string" != typeof(n = n || "") && (n = n.toString()), void 0 === g) throw new Error("printLabelAsync(): labelXml parameter should be specified");
    return "string" != typeof g && (g = g.toString()), dymo.label.framework.getPrintersAsync().then(function(e) {
        var o = e[t];
        if (goog.isDefAndNotNull(o)) return ASSUME_MOBILE || o.isNetworkPrinter() ? printLabelToNetworkPrinter(o, r, g, n) : _createFramework().printLabelAsync(o.name, r, g, n);
        throw new Error("printLabelAsync(): unknown printer '" + t + "'")
    })
}, dymo.label.framework.printLabel2 = function(e, o, t, r) {
    if (o = o || "", "string" != typeof(r = r || "") && (r = r.toString()), void 0 === t) throw new Error("printLabel2(): labelXml parameter should be specified");
    "string" != typeof t && (t = t.toString());
    var g = dymo.label.framework.getPrinters()[e];
    if (goog.isDefAndNotNull(g)) return ASSUME_MOBILE || g.isNetworkPrinter() ? printLabelToNetworkPrinter(g, o, t, r) : new dymo.label.framework.PrintJob(g, _createFramework().printLabel2(e, o, t, r));
    throw new Error("printLabel(): unknown printer '" + e + "'")
}, dymo.label.framework.printLabel2Async = function(t, r, g, n) {
    if (r = r || "", "string" != typeof(n = n || "") && (n = n.toString()), void 0 === g) throw new Error("printLabel2Async(): labelXml parameter should be specified");
    return "string" != typeof g && (g = g.toString()), dymo.label.framework.getPrintersAsync().then(function(e) {
        var o = e[t];
        if (goog.isDefAndNotNull(o)) return ASSUME_MOBILE || o.isNetworkPrinter() ? printLabelToNetworkPrinter(o, r, g, n) : _createFramework().printLabel2Async(t, r, g, n).then(function(e) {
        ...
        a = function(e) {
            if (g(i, e)) {
                var o = new goog.async.Delay(function() {
                    i.getStatus(a), o.dispose()
                }, n);
                o.start()
            }
        };
    return i.getStatus(a), i
    ...
    if (void 0 === e) throw new Error("renderLabel(): labelXml parameter should be specified");
    return "string" != typeof e && (e = e.toString()), o = o || "", t = t || "", _createFramework().renderLabel(e, o, t)
}, dymo.label.framework.renderLabelAsync = function(e, o, t) {
    if (void 0 === e) throw new Error("renderLabelAsync(): labelXml parameter should be specified");
    return "string" != typeof e && (e = e.toString()), o = o || "", t = t || "", _createFramework().renderLabelAsync(e, o, t)
    ...
    var o = dymo.xml.parse("<LabelWriterPrintParams/>"),
        t = o.documentElement;
    return e.copies && dymo.xml.appendElement(t, "Copies", e.copies.toString()), e.jobTitle && dymo.xml.appendElement(t, "JobTitle", e.jobTitle), e.flowDirection && dymo.xml.appendElement(t, "FlowDirection", e.flowDirection), e.printQuality && dymo.xml.appendElement(t, "PrintQuality", e.printQuality), e.twinTurboRoll && dymo.xml.appendElement(t, "TwinTurboRoll", e.twinTurboRoll), dymo.xml.serialize(o)
}, dymo.label.framework.createTapePrintParamsXml = function(e) {
    if (!e) return "";
    var o = dymo.xml.parse("<TapePrintParams/>"),
        t = o.documentElement;
    return e.copies && dymo.xml.appendElement(t, "Copies", e.copies.toString()), e.jobTitle && dymo.xml.appendElement(t, "JobTitle", e.jobTitle), e.flowDirection && dymo.xml.appendElement(t, "FlowDirection", e.flowDirection), e.alignment && dymo.xml.appendElement(t, "Alignment", e.alignment), e.cutMode && dymo.xml.appendElement(t, "CutMode", e.cutMode), dymo.xml.serialize(o)
    ...
    var t = dymo.xml.parse("<LabelRenderParams/>"),
        r = t.documentElement;
    return e.labelColor && o("LabelColor", e.labelColor), e.shadowColor && o("ShadowColor", e.shadowColor), void 0 !== e.shadowDepth && dymo.xml.appendElement(r, "ShadowDepth", e.shadowDepth.toString()), e.flowDirection && dymo.xml.appendElement(r, "FlowDirection", e.flowDirection), void 0 !== e.pngUseDisplayResolution && dymo.xml.appendElement(r, "PngUseDisplayResolution", e.pngUseDisplayResolution ? "True" : "False"), dymo.xml.serialize(t)
};